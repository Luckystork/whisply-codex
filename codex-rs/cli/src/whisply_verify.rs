...
impl IsolatedProductHome {
    fn create() -> anyhow::Result<Self> {
        ...
        for path in [&home, &whisply_home, &codex_home] {
...
const USER_CONFIGURED_FEATURE_COVERAGE: &[UserConfiguredFeatureCoverage] = &[
    UserConfiguredFeatureCoverage {
        ...
        fixture_paths: &[
            "Runtime/whisply-codex/codex-rs/core/src/tools/spec_plan_tests.rs",
            "Runtime/whisply-codex/codex-rs/core/tests/suite/tool_harness.rs",
            "Runtime/whisply-codex/codex-rs/ext/goal/tests/goal_extension_backend.rs",
            "Runtime/whisply-codex/codex-rs/app-server/tests/suite/v2/thread_resume.rs",
        ],
    ...
    UserConfiguredFeatureCoverage {
        ...
        fixture_paths: &[
            "Runtime/whisply-codex/codex-rs/core/tests/suite/hooks.rs",
            "Runtime/whisply-codex/codex-rs/core/tests/suite/hooks_mcp.rs",
        ],
        later_integration_evidence: None,
    },
    UserConfiguredFeatureCoverage {
        ...
        fixture_paths: &[
            "Runtime/whisply-codex/codex-rs/core/tests/suite/rmcp_client.rs",
            "Runtime/whisply-codex/codex-rs/rmcp-client/tests/streamable_http_oauth_startup.rs",
            "Runtime/whisply-codex/codex-rs/rmcp-client/tests/resources.rs",
        ],
    ...
    UserConfiguredFeatureCoverage {
        ...
        fixture_paths: &[
            "Runtime/whisply-codex/codex-rs/core/tests/suite/plugins.rs",
            "Runtime/whisply-codex/codex-rs/core-plugins/src/store_tests.rs",
            "Runtime/whisply-codex/codex-rs/core-plugins/src/loader_tests.rs",
        ],
        later_integration_evidence: Some(
    ...
    UserConfiguredFeatureCoverage {
        ...
        fixture_paths: &[
            "Runtime/whisply-codex/codex-rs/core/tests/suite/skills.rs",
            "Runtime/whisply-codex/codex-rs/core/tests/suite/skills_extension.rs",
            "Runtime/whisply-codex/codex-rs/skills/src/selection_tests.rs",
            "Runtime/whisply-codex/codex-rs/ext/skills/tests/skills_extension.rs",
        ],
        later_integration_evidence: Some(
    ...
    UserConfiguredFeatureCoverage {
        ...
        fixture_paths: &[
            "Runtime/whisply-codex/codex-rs/core/tests/suite/multi_agent_resume.rs",
            "Runtime/whisply-codex/codex-rs/core/tests/suite/agent_execution.rs",
        ],
        later_integration_evidence: None,
    },
    UserConfiguredFeatureCoverage {
        ...
        fixture_paths: &[
            "Runtime/whisply-codex/codex-rs/core/tests/suite/apply_patch_cli.rs",
            "Runtime/whisply-codex/codex-rs/core/tests/suite/unified_exec.rs",
    ...
    UserConfiguredFeatureCoverage {
        ...
        later_integration_evidence: Some(
            "Installed Browser/Chrome setup, extension connection, TCC prompts, overlay, and Stop behavior remain macOS/UI evidence.",
        ),
    },
    UserConfiguredFeatureCoverage {
        feature: "connectors",
        ...
        later_integration_evidence: Some(
            "Owner-approved third-party connector consent, reconnect, and revoke flows remain integration evidence.",
        ),
    },
];
...
fn verification_sandbox(check: &VerificationCheck) -> VerificationSandbox {
    match check.id {
        ...
        // so these four fixed suites must own the inner sandbox. Their verifier
        ...
        | "rust-core-full"
        | "rust-exec-server-full"
        | "rust-exec-full" => VerificationSandbox::TestSuiteOwnsSeatbelt,
...
const VERIFY_MANIFEST: &[VerificationCheck] = &[
    ...
    VerificationCheck {
        ...
        action: CheckAction::Run {
            ...
            required_paths: &[
                ...
                "Runtime/whisply-codex/codex-rs/cli/src/whisply_diagnostics/installed_live.rs",
    ...
    VerificationCheck {
        ...
        action: CheckAction::Run {
            ...
            required_paths: &[
                ...
                "Runtime/whisply-codex/codex-rs/app-server/tests/suite/v2/mod.rs",
            ],
        },
    ...
    VerificationCheck {
        ...
        action: CheckAction::Run {
            program: "cargo",
            args: &["test", "--offline", "-p", "codex-cli", "--all-targets"],
            working_directory: "Runtime/whisply-codex/codex-rs",
            required_paths: &[
                "Runtime/whisply-codex/codex-rs/Cargo.lock",
                "Runtime/whisply-codex/codex-rs/cli/tests/mcp_list.rs",
            ],
        },
    ...
    VerificationCheck {
        ...
        action: CheckAction::Run {
            ...
            working_directory: "Runtime/whisply-codex/codex-rs",
            required_paths: &["Runtime/whisply-codex/codex-rs/code-mode-host/Cargo.toml"],
        },
    ...
    VerificationCheck {
        ...
        action: CheckAction::Run {
            program: "cargo",
            args: &["test", "--offline", "-p", "codex-core", "--all-targets"],
            working_directory: "Runtime/whisply-codex/codex-rs",
            required_paths: &[
                "Runtime/whisply-codex/codex-rs/Cargo.lock",
                "Runtime/whisply-codex/codex-rs/core/src/config/config_tests.rs",
                "Runtime/whisply-codex/codex-rs/core/src/realtime_conversation_tests.rs",
                "Runtime/whisply-codex/codex-rs/core/src/tools/spec_plan_tests.rs",
                "Runtime/whisply-codex/codex-rs/core/tests/suite/tool_harness.rs",
                "Runtime/whisply-codex/codex-rs/core/tests/suite/hooks.rs",
                "Runtime/whisply-codex/codex-rs/core/tests/suite/hooks_mcp.rs",
                ...
                "Runtime/whisply-codex/codex-rs/core/tests/suite/apply_patch_cli.rs",
                "Runtime/whisply-codex/codex-rs/core/tests/suite/unified_exec.rs",
                "Runtime/whisply-codex/codex-rs/core/tests/suite/view_image.rs",
            ],
        },
    ...
    VerificationCheck {
        ...
        action: CheckAction::Run {
            program: "cargo",
            args: &["test", "--offline", "-p", "codex-config", "--lib"],
            working_directory: "Runtime/whisply-codex/codex-rs",
            required_paths: &[
                "Runtime/whisply-codex/codex-rs/Cargo.lock",
                "Runtime/whisply-codex/codex-rs/config/src/loader/mod.rs",
            ],
        },
    ...
    VerificationCheck {
        ...
        action: CheckAction::Run {
            ...
            required_paths: &[
                "Runtime/whisply-codex/codex-rs/Cargo.lock",
                "Runtime/whisply-codex/codex-rs/ext/goal/src/tool.rs",
                "Runtime/whisply-codex/codex-rs/ext/goal/tests/goal_extension_backend.rs",
            ],
        },
    ...
    VerificationCheck {
        ...
        action: CheckAction::Run {
            program: "cargo",
            args: &["test", "--offline", "-p", "codex-model-provider", "--lib"],
            working_directory: "Runtime/whisply-codex/codex-rs",
            required_paths: &[
                "Runtime/whisply-codex/codex-rs/Cargo.lock",
                "Runtime/whisply-codex/codex-rs/model-provider/src/whisply.rs",
            ],
        },
    ...
    VerificationCheck {
        ...
        action: CheckAction::Run {
            ...
            required_paths: &[
                "Runtime/whisply-codex/codex-rs/Cargo.lock",
                "Runtime/whisply-codex/codex-rs/whisply-runtime/src/broker.rs",
            ],
        },
    ...
    VerificationCheck {
        ...
        action: CheckAction::Run {
            program: "cargo",
            args: &["test", "--offline", "-p", "codex-mcp", "--lib"],
            working_directory: "Runtime/whisply-codex/codex-rs",
            required_paths: &[
                "Runtime/whisply-codex/codex-rs/Cargo.lock",
                "Runtime/whisply-codex/codex-rs/codex-mcp/src/mcp/mod_tests.rs",
            ],
        },
    ...
    VerificationCheck {
        ...
        action: CheckAction::Run {
            ...
            required_paths: &[
                "Runtime/whisply-codex/codex-rs/Cargo.lock",
                "Runtime/whisply-codex/codex-rs/ext/mcp/tests/executor_plugin_mcp.rs",
            ],
        },
    ...
    VerificationCheck {
        ...
        action: CheckAction::Run {
            ...
            required_paths: &[
                "Runtime/whisply-codex/codex-rs/Cargo.lock",
                "Runtime/whisply-codex/codex-rs/mcp-server/tests/suite/codex_tool.rs",
                "Runtime/whisply-codex/codex-rs/app-server/tests/common/managed_whisply_gateway.rs",
            ],
        },
    ...
    VerificationCheck {
        ...
        action: CheckAction::Run {
            program: "cargo",
            args: &["test", "--offline", "-p", "codex-core-plugins", "--lib"],
            working_directory: "Runtime/whisply-codex/codex-rs",
            required_paths: &[
                "Runtime/whisply-codex/codex-rs/Cargo.lock",
                "Runtime/whisply-codex/codex-rs/core-plugins/src/store_tests.rs",
    ...
    VerificationCheck {
        ...
        action: CheckAction::Run {
            program: "cargo",
            args: &["test", "--offline", "-p", "codex-plugin", "--lib"],
            working_directory: "Runtime/whisply-codex/codex-rs",
            required_paths: &[
                "Runtime/whisply-codex/codex-rs/Cargo.lock",
                "Runtime/whisply-codex/codex-rs/plugin/Cargo.toml",
            ],
        },
    ...
    VerificationCheck {
        ...
        action: CheckAction::Run {
            program: "cargo",
            args: &["test", "--offline", "-p", "codex-skills", "--lib"],
            working_directory: "Runtime/whisply-codex/codex-rs",
            required_paths: &[
                "Runtime/whisply-codex/codex-rs/Cargo.lock",
                "Runtime/whisply-codex/codex-rs/skills/src/selection_tests.rs",
    ...
    VerificationCheck {
        ...
        action: CheckAction::Run {
            ...
            required_paths: &[
                "Runtime/whisply-codex/codex-rs/Cargo.lock",
                "Runtime/whisply-codex/codex-rs/core-skills/src/loader_tests.rs",
                "Runtime/whisply-codex/codex-rs/core-skills/tests/environment_loader.rs",
            ],
        },
    ...
    VerificationCheck {
        ...
        action: CheckAction::Run {
            ...
            required_paths: &[
                "Runtime/whisply-codex/codex-rs/Cargo.lock",
                "Runtime/whisply-codex/codex-rs/ext/skills/src/host_roots_tests.rs",
                "Runtime/whisply-codex/codex-rs/ext/skills/tests/skills_extension.rs",
            ],
        },
    ...
    VerificationCheck {
        ...
        action: CheckAction::Run {
            program: "cargo",
            args: &["test", "--offline", "-p", "codex-external-agent-migration"],
            working_directory: "Runtime/whisply-codex/codex-rs",
            required_paths: &[
                "Runtime/whisply-codex/codex-rs/Cargo.lock",
                "Runtime/whisply-codex/codex-rs/external-agent-migration/src/mcp.rs",
                "Runtime/whisply-codex/codex-rs/external-agent-migration/src/service_tests/plugins/marketplaces.rs",
            ],
        },
    ...
    VerificationCheck {
        ...
        action: CheckAction::Run {
            ...
            required_paths: &[
                "Runtime/whisply-codex/codex-rs/Cargo.lock",
                "Runtime/whisply-codex/codex-rs/exec-server/tests/websocket.rs",
                "Runtime/whisply-codex/codex-rs/exec-server/tests/http_request.rs",
            ],
        },
    ...
    VerificationCheck {
        ...
        action: CheckAction::Run {
            program: "cargo",
            args: &["test", "--offline", "-p", "codex-exec", "--all-targets"],
            working_directory: "Runtime/whisply-codex/codex-rs",
            required_paths: &[
                "Runtime/whisply-codex/codex-rs/Cargo.lock",
                "Runtime/whisply-codex/codex-rs/exec/tests/all.rs",
            ],
        },
    ...
    VerificationCheck {
        ...
        action: CheckAction::Run {
            ...
            required_paths: &[
                "Runtime/whisply-codex/codex-rs/Cargo.lock",
                "Runtime/whisply-codex/codex-rs/app-server-transport/src/lib.rs",
            ],
        },
    ...
    VerificationCheck {
        ...
        action: CheckAction::Run {
            program: "cargo",
            args: &["build", "--offline", "-p", "codex-cli", "--bin", "whisply"],
            working_directory: "Runtime/whisply-codex/codex-rs",
            required_paths: &["Runtime/whisply-codex/codex-rs/cli/Cargo.toml"],
        },
    ...
    VerificationCheck {
        ...
        action: CheckAction::Run {
            ...
            working_directory: "Runtime/whisply-codex/codex-rs",
            required_paths: &["Runtime/whisply-codex/codex-rs/rmcp-client/Cargo.toml"],
        },
    ...
    VerificationCheck {
        ...
        action: CheckAction::Run {
            ...
            required_paths: &[
                ...
                "Runtime/whisply-codex/codex-rs/app-server/tests/suite/v2/mod.rs",
                "Runtime/whisply-codex/codex-rs/app-server/tests/suite/v2/thread_resume.rs",
                "Runtime/whisply-codex/codex-rs/app-server/tests/suite/v2/view_image.rs",
                "Runtime/whisply-codex/codex-rs/app-server/tests/common/managed_whisply_gateway.rs",
            ],
        },
    ...
    VerificationCheck {
        ...
        action: CheckAction::Run {
            program: "cargo",
            args: &["test", "--offline", "-p", "codex-tui", "--all-targets"],
            working_directory: "Runtime/whisply-codex/codex-rs",
            required_paths: &[
                "Runtime/whisply-codex/codex-rs/Cargo.lock",
                "Runtime/whisply-codex/codex-rs/tui/tests/all.rs",
                "Runtime/whisply-codex/codex-rs/tui/tests/suite/vt100_live_commit.rs",
            ],
        },
...
fn feature_coverage(feature: VerifyFeature) -> &'static UserConfiguredFeatureCoverage {
    USER_CONFIGURED_FEATURE_COVERAGE
        .iter()
        .find(|coverage| coverage.feature == feature.coverage_id())
        .expect("every fixed feature selector must have one coverage record")
}
    ...
    loop {
        ...
        for (dependent_id, prerequisite_ids) in VERIFY_CHECK_PREREQUISITES {
            ...
            for prerequisite_id in *prerequisite_ids {
                let prerequisite = VERIFY_MANIFEST
                    .iter()
                    .find(|check| check.id == *prerequisite_id)
                    .expect(
                        "every fixed verification prerequisite must be present in the manifest",
                    );
...
fn run_check(source_root: &Path, check: &VerificationCheck, dry_run: bool) -> CheckResult {
    ...
    let result = match check.action {
        ...
        CheckAction::Run {
            ...
            if dry_run {
            ...
            } else if missing_local_prerequisite(source_root, required_paths) {
                CheckResult {
                    id: check.id,
                    suite: check.suite,
                    status: CheckStatus::Blocked,
                ...
                child
                    ...
                    .env_clear()
                    .args(args)
                    .current_dir(source_root.join(working_directory))
                    ...
                    // Let each test-owned CODEX_HOME choose its own SQLite
                    // home. A single runner-level override makes parallel
                    // app-server fixtures contend for one state database.
                    .env("CODEX_HOME", &isolated_home.codex_home);
                if program == "cargo" {
...
mod tests {
    ...
    fn release_test_full_selects_every_defined_group_without_a_child_action() {
        ...
        assert_eq!(USER_CONFIGURED_FEATURE_COVERAGE.len(), 9);
    ...
    fn feature_selectors_choose_only_their_fixed_coverage_checks_and_prerequisites() {
        ...
        assert!(select_verify_checks(VerifySuite::Website, &[VerifyFeature::Skills]).is_empty());
        ...
        for feature in [
            ...
            assert_eq!(feature_coverage(feature).feature, feature.coverage_id());
        }
    }
    ...
    fn child_product_homes_are_isolated_empty_directories() -> anyhow::Result<()> {
        ...
        assert_ne!(isolated_home.whisply_home, isolated_home.codex_home);
        Ok(())
    }
