...
pub const MODEL_CATALOG_SCHEMA_VERSION: u16 = 1;
...
mod tests {
    ...
    #[test]
    fn static_worker_catalog_fixture_verifies_rotated_key_and_preserves_haiku_shape() {
        ...
        assert!(
            fixture
                .envelope
                .verify_at(&fixture.key_set, 1_786_126_401)
                .is_ok()
        );
        ...
        assert!(matches!(
            fixture.envelope.verify_at(&retired_only, 1_786_126_401),
