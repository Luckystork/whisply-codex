...
#[tokio::test]
async fn app_read_rejects_direct_authority_before_validation_or_upstream_io() -> Result<()> {
    ...
    let request_id = app_server
        .send_apps_read_request(AppsReadParams {
            // app/read's upstream limit check must remain unreachable behind
            // the Whisply authority gate.
