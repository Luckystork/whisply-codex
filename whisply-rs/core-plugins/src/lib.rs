...
#[cfg(test)]
#[path = "plugin_child_env_tests.rs"]
mod plugin_child_env_tests;
pub mod plugin_disclosure;
pub mod plugin_package_pin;
mod provider;
pub mod remote;
...
pub type LoadedPlugin = whisply_plugin::LoadedPlugin<whisply_config::McpServerConfig>;
pub type PluginLoadOutcome = whisply_plugin::PluginLoadOutcome<whisply_config::McpServerConfig>;
...
pub use manager::PluginLaunchReview;
pub use manager::PluginListBackgroundTaskOptions;
pub use manager::PluginMcpLaunchApproval;
