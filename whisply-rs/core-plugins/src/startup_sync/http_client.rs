...
//! preserve the legacy `whisply_login::default_client::create_client_without_request_logging()`
...
use whisply_http_client::RequestBuilder;
use whisply_http_client::RouteAwareClientPool;
use whisply_http_client::RouteAwareRequestBuilder;
use whisply_login::default_client::create_client_without_request_logging;
