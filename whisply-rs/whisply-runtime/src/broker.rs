        ...
        match response.status.as_str() {
            ...
            "error" => {
                ...
                match response.code {
                    ...
                    None => Err(BrokerError::InvalidMessage),
                }
            }
...
mod tests {
    ...
    unsafe fn rights_message_for_test(
        ...
        unsafe {
            ...
            (*current).cmsg_len = libc::CMSG_LEN(std::mem::size_of_val(descriptors) as _) as _;
