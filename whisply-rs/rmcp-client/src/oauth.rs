...
//!
//! If the keyring is not available or fails, we fall back to WHISPLY_HOME/.credentials.json which is consistent with other coding CLI agents.
...
mod tests {
    ...
    use std::sync::Arc;
    use whisply_keyring_store::tests::MockKeyringStore;
    use whisply_secrets::compute_keyring_account;
