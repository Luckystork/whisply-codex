...
use whisply_core_plugins::manifest::parse_plugin_manifest_uri;
use whisply_exec_server::CapabilityRootDiscovery;
use whisply_mcp::parse_executor_plugin_mcp_config;
...
fn parse_mcp_servers(
    selected_root: &SelectedCapabilityRoot,
    plugin_root: &whisply_utils_path_uri::PathUri,
    contents: &str,
    environment_id: &str,
) -> Vec<(String, whisply_config::McpServerConfig)> {
