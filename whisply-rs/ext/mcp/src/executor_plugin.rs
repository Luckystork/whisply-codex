...
use std::sync::Arc;
use std::sync::Mutex;
use whisply_connectors_extension::ExecutorPluginConnectorProvider;
use whisply_core::config::Config;
use whisply_core_plugins::ExecutorPluginProvider;
...
struct SelectedPluginMetadata {
    ...
    servers: Vec<(String, whisply_config::McpServerConfig)>,
