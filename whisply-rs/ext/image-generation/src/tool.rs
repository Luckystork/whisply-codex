...
use whisply_extension_api::parse_tool_input_schema;
...
use whisply_utils_image::PromptImageMode;
use whisply_utils_image::load_for_prompt_bytes;
...
impl ToolExecutor<ToolCall> for ImageGenerationTool {
    ...
    fn handle(&self, call: ToolCall) -> whisply_extension_api::ToolExecutorFuture<'_> {
