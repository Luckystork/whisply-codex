...
use whisply_extension_api::ConversationHistory;
use whisply_extension_api::ExtensionData;
use whisply_extension_api::ExtensionEventSink;
use whisply_extension_api::ExtensionMetrics;
...
use whisply_extension_api::WorldStateContributionInput;
use whisply_extension_api::WorldStateSectionContribution;
use whisply_models_manager::model_info::model_info_from_slug;
use whisply_otel::MetricsClient;
use whisply_otel::MetricsConfig;
use whisply_otel::THREAD_SKILLS_DESCRIPTION_TRUNCATED_CHARS_METRIC;
use whisply_otel::THREAD_SKILLS_ENABLED_TOTAL_METRIC;
use whisply_otel::THREAD_SKILLS_KEPT_TOTAL_METRIC;
use whisply_otel::THREAD_SKILLS_TRUNCATED_METRIC;
...
use whisply_protocol::protocol::SKILLS_INSTRUCTIONS_CLOSE_TAG;
...
use whisply_skills_extension::HostSkillProvider;
use whisply_skills_extension::HostSkillsSnapshot;
use whisply_skills_extension::SkillProviders;
use whisply_skills_extension::SkillsExtensionConfig;
use whisply_skills_extension::catalog::SkillAuthority;
use whisply_skills_extension::catalog::SkillCatalog;
use whisply_skills_extension::catalog::SkillCatalogEntry;
use whisply_skills_extension::catalog::SkillPackageId;
use whisply_skills_extension::catalog::SkillProviderError;
use whisply_skills_extension::catalog::SkillReadResult;
use whisply_skills_extension::catalog::SkillResourceId;
use whisply_skills_extension::catalog::SkillSearchResult;
use whisply_skills_extension::catalog::SkillSourceKind;
use whisply_skills_extension::install;
use whisply_skills_extension::install_with_providers;
use whisply_skills_extension::install_with_providers_and_metrics;
use whisply_skills_extension::provider::SkillListQuery;
use whisply_skills_extension::provider::SkillProvider;
use whisply_skills_extension::provider::SkillProviderFuture;
use whisply_skills_extension::provider::SkillReadRequest;
use whisply_skills_extension::provider::SkillSearchRequest;
...
async fn skill_world_state_fragments(
    registry: &whisply_extension_api::ExtensionRegistry<TestConfig>,
    ...
    let sections = registry.context_contributors()[0]
        .contribute_world_state(WorldStateContributionInput {
            thread_id: whisply_protocol::ThreadId::new(),
            turn_id,
            environments: &[],
