...
use whisply_core_skills::loader::load_environment_skills_from_root as load_legacy_environment_skills_from_root;
...
use whisply_skills_extension::ExecutorSkillProvider;
...
async fn executor_discovery_routes_produce_equivalent_catalog_metadata() {
    ...
    let comparable_entries = |catalog: &whisply_skills_extension::catalog::SkillCatalog| {
        catalog
            .entries
            .iter()
            .map(|entry| {
