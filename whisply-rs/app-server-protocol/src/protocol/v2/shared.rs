...
use whisply_protocol::config_types::ApprovalsReviewer as CoreApprovalsReviewer;
use whisply_protocol::config_types::SandboxMode as CoreSandboxMode;
...
use whisply_protocol::protocol::NonSteerableTurnKind as CoreNonSteerableTurnKind;
...
impl From<CoreCodexErrorInfo> for CodexErrorInfo {
    fn from(value: CoreCodexErrorInfo) -> Self {
        match value {
            ...
            CoreCodexErrorInfo::StorageFull => CodexErrorInfo::StorageFull,
