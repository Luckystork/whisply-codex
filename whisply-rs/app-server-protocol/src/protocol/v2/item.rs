...
use whisply_experimental_api_macros::ExperimentalApi;
use whisply_extension_items::ExtensionItem;
pub use whisply_extension_items::image_generation::ImageGenerationItem;
pub use whisply_extension_items::sleep::SleepItem;
pub use whisply_extension_items::web_search::WebSearchAction;
pub use whisply_extension_items::web_search::WebSearchItem;
use whisply_protocol::approvals::GuardianAssessmentAction as CoreGuardianAssessmentAction;
use whisply_protocol::approvals::GuardianAssessmentDecisionSource as CoreGuardianAssessmentDecisionSource;
use whisply_protocol::approvals::GuardianCommandSource as CoreGuardianCommandSource;
...
use whisply_protocol::parse_command::ParsedCommand as CoreParsedCommand;
...
use whisply_protocol::protocol::GuardianRiskLevel as CoreGuardianRiskLevel;
use whisply_protocol::protocol::GuardianUserAuthorization as CoreGuardianUserAuthorization;
use whisply_protocol::protocol::PatchApplyStatus as CorePatchApplyStatus;
use whisply_protocol::protocol::ReviewDecision as CoreReviewDecision;
...
pub enum GuardianApprovalReviewStatus {
    ...
    TimedOut,
    Aborted,
    /// The review ended without a verdict and the approval was handed to the
    /// person. Terminal for the review, but the action was neither approved
    /// nor refused by it.
    AskUser,
}
...
pub(crate) fn web_search_action_from_core(
    value: whisply_protocol::models::WebSearchAction,
) -> WebSearchAction {
    match value {
        whisply_protocol::models::WebSearchAction::Search { query, queries } => {
            WebSearchAction::Search { query, queries }
        }
        whisply_protocol::models::WebSearchAction::OpenPage { url } => {
            WebSearchAction::OpenPage { url }
        }
        whisply_protocol::models::WebSearchAction::FindInPage { url, pattern } => {
            WebSearchAction::FindInPage { url, pattern }
        }
        whisply_protocol::models::WebSearchAction::Other => WebSearchAction::Other,
    }
}
...
impl From<whisply_protocol::items::HookPromptFragment> for HookPromptFragment {
    fn from(value: whisply_protocol::items::HookPromptFragment) -> Self {
        Self {
            text: value.text,
...
impl From<whisply_protocol::dynamic_tools::DynamicToolCallOutputContentItem>
    for DynamicToolCallOutputContentItem
{
    fn from(item: whisply_protocol::dynamic_tools::DynamicToolCallOutputContentItem) -> Self {
        match item {
...
impl From<DynamicToolCallOutputContentItem>
    for whisply_protocol::dynamic_tools::DynamicToolCallOutputContentItem
{
