...
use whisply_protocol::items::McpToolCallError as CoreMcpToolCallError;
use whisply_protocol::mcp::CallToolResult as CoreMcpCallToolResult;
use whisply_protocol::mcp::McpServerInfo;
use whisply_protocol::mcp::Resource as McpResource;
pub use whisply_protocol::mcp::ResourceContent as McpResourceContent;
use whisply_protocol::mcp::ResourceTemplate as McpResourceTemplate;
use whisply_protocol::mcp::Tool as McpTool;

v2_enum_from_core!(
    pub enum McpAuthStatus from whisply_protocol::protocol::McpAuthStatus {
        Unknown,
        Unsupported,
        NotLoggedIn,
        BearerToken,
...
v2_enum_from_core!(
    pub enum McpServerStartupFailureReason from whisply_protocol::protocol::McpStartupFailureReason {
...
impl McpServerElicitationAction {
    pub fn to_core(self) -> whisply_protocol::approvals::ElicitationAction {
        match self {
            Self::Accept => whisply_protocol::approvals::ElicitationAction::Accept,
            Self::Decline => whisply_protocol::approvals::ElicitationAction::Decline,
            Self::Cancel => whisply_protocol::approvals::ElicitationAction::Cancel,
        }
    }
}
