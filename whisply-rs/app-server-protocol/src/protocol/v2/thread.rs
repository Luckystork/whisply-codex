...
pub use whisply_protocol::capabilities::CapabilityRootLocation;
pub use whisply_protocol::capabilities::SelectedCapabilityRoot;
...
use whisply_protocol::protocol::ThreadGoalStatus as CoreThreadGoalStatus;
use whisply_protocol::protocol::TokenUsage as CoreTokenUsage;
use whisply_protocol::protocol::TokenUsageInfo as CoreTokenUsageInfo;
...
pub struct ThreadStartParams {
    ...
    #[serde(
        default,
        deserialize_with = "whisply_protocol::dynamic_tools::deserialize_dynamic_tool_specs"
    )]
    #[ts(optional = nullable)]
...
impl From<whisply_protocol::protocol::ThreadGoal> for ThreadGoal {
    fn from(value: whisply_protocol::protocol::ThreadGoal) -> Self {
        Self {
...
impl ThreadMemoryMode {
    ...
    pub fn to_core(self) -> whisply_protocol::protocol::ThreadMemoryMode {
        match self {
            Self::Enabled => whisply_protocol::protocol::ThreadMemoryMode::Enabled,
            Self::Disabled => whisply_protocol::protocol::ThreadMemoryMode::Disabled,
        }
    }
}
...
pub struct ThreadApproveGuardianDeniedActionParams {
    pub thread_id: String,
    /// Serialized `whisply_protocol::protocol::GuardianAssessmentEvent`.
    pub event: JsonValue,
}
