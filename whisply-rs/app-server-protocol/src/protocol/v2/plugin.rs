...
use whisply_protocol::protocol::SkillDependencies as CoreSkillDependencies;
use whisply_protocol::protocol::SkillInterface as CoreSkillInterface;
use whisply_protocol::protocol::SkillMetadata as CoreSkillMetadata;
use whisply_protocol::protocol::SkillScope as CoreSkillScope;
use whisply_protocol::protocol::SkillToolDependency as CoreSkillToolDependency;
...
pub struct PluginDetail {
    ...
    #[serde(default)]
    pub mcp_server_launches: Vec<PluginMcpLaunchSummary>,
    ...
    #[serde(default)]
    pub refused_host_env_vars: Vec<String>,
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct PluginMcpLaunchSummary {
...
/// Older peers omit `handlerType` entirely. Treating those as command handlers
/// keeps the conservative reading: a hook whose kind is unknown is assumed to
/// be one that executes.
fn default_hook_handler_type() -> HookHandlerType {
