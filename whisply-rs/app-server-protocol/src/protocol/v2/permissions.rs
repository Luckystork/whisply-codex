...
use std::path::Path;
use whisply_protocol::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
use whisply_protocol::approvals::NetworkApprovalContext as CoreNetworkApprovalContext;
use whisply_protocol::approvals::NetworkApprovalProtocol as CoreNetworkApprovalProtocol;
use whisply_protocol::approvals::NetworkPolicyAmendment as CoreNetworkPolicyAmendment;
use whisply_protocol::approvals::NetworkPolicyRuleAction as CoreNetworkPolicyRuleAction;
use whisply_protocol::models::ActivePermissionProfile as CoreActivePermissionProfile;
...
use whisply_protocol::models::LegacyReadWriteRoots;
...
use whisply_utils_path_uri::PathConvention;
...
impl SandboxPolicy {
    pub fn to_core(&self) -> whisply_protocol::protocol::SandboxPolicy {
        match self {
...
impl From<whisply_protocol::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: whisply_protocol::protocol::SandboxPolicy) -> Self {
        match value {
            whisply_protocol::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }
            whisply_protocol::protocol::SandboxPolicy::ReadOnly { network_access } => {
                SandboxPolicy::ReadOnly { network_access }
            }
            whisply_protocol::protocol::SandboxPolicy::ExternalSandbox { network_access } => {
