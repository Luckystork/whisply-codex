...
use whisply_protocol::protocol::SubAgentSource as CoreSubAgentSource;
use whisply_protocol::protocol::ThreadHistoryMode as CoreThreadHistoryMode;
use whisply_protocol::protocol::ThreadSource as CoreThreadSource;
