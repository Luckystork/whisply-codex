...
use serde::Serialize;
use whisply_protocol::protocol::HookEventName as CoreHookEventName;
use whisply_protocol::protocol::HookExecutionMode as CoreHookExecutionMode;
use whisply_protocol::protocol::HookHandlerType as CoreHookHandlerType;
use whisply_protocol::protocol::HookOutputEntry as CoreHookOutputEntry;
use whisply_protocol::protocol::HookOutputEntryKind as CoreHookOutputEntryKind;
use whisply_protocol::protocol::HookRunStatus as CoreHookRunStatus;
use whisply_protocol::protocol::HookRunSummary as CoreHookRunSummary;
use whisply_protocol::protocol::HookScope as CoreHookScope;
use whisply_protocol::protocol::HookSource as CoreHookSource;
use whisply_protocol::protocol::HookTrustStatus as CoreHookTrustStatus;
