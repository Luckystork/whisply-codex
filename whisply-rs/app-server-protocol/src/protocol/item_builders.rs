...
use whisply_protocol::protocol::ReviewOutputEvent;
use whisply_protocol::review_format::REVIEW_FALLBACK_MESSAGE;
use whisply_protocol::review_format::render_review_output_text;
use whisply_secrets::redact_secrets;
...
pub fn guardian_auto_approval_review_notification(
    ...
    let review = GuardianApprovalReview {
        status: match assessment.status {
            ...
            whisply_protocol::protocol::GuardianAssessmentStatus::AskUser => {
                GuardianApprovalReviewStatus::AskUser
            }
        },
