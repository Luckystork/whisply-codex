...
pub(crate) fn completed_summary(
    ...
    entries: Vec<whisply_protocol::protocol::HookOutputEntry>,
) -> HookRunSummary {
    HookRunSummary {
        id: handler.run_id(),
        event_name: handler.event_name,
...
pub(crate) fn hook_source_label(source: whisply_protocol::protocol::HookSource) -> &'static str {
    match source {
        whisply_protocol::protocol::HookSource::System => "system",
        whisply_protocol::protocol::HookSource::User => "user",
        whisply_protocol::protocol::HookSource::Project => "project",
        whisply_protocol::protocol::HookSource::Mdm => "mdm",
        whisply_protocol::protocol::HookSource::SessionFlags => "session_flags",
        whisply_protocol::protocol::HookSource::Plugin => "plugin",
        whisply_protocol::protocol::HookSource::CloudRequirements => "cloud_requirements",
        whisply_protocol::protocol::HookSource::CloudManagedConfig => "cloud_managed_config",
        whisply_protocol::protocol::HookSource::LegacyManagedConfigFile => {
            "legacy_managed_config_file"
        }
        whisply_protocol::protocol::HookSource::LegacyManagedConfigMdm => {
            "legacy_managed_config_mdm"
        }
        whisply_protocol::protocol::HookSource::Unknown => "unknown",
    }
}
