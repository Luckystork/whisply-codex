...
use whisply_protocol::protocol::HookTrustStatus;
...
pub(crate) struct ConfiguredHandler {
    pub event_name: whisply_protocol::protocol::HookEventName,
...
impl ConfiguredHandler {
    ...
    fn event_name_label(&self) -> &'static str {
        match self.event_name {
            whisply_protocol::protocol::HookEventName::PreToolUse => "pre-tool-use",
            whisply_protocol::protocol::HookEventName::PermissionRequest => "permission-request",
            whisply_protocol::protocol::HookEventName::PostToolUse => "post-tool-use",
            whisply_protocol::protocol::HookEventName::PreCompact => "pre-compact",
            whisply_protocol::protocol::HookEventName::PostCompact => "post-compact",
            whisply_protocol::protocol::HookEventName::SessionStart => "session-start",
            whisply_protocol::protocol::HookEventName::SessionEnd => "session-end",
            whisply_protocol::protocol::HookEventName::UserPromptSubmit => "user-prompt-submit",
            whisply_protocol::protocol::HookEventName::SubagentStart => "subagent-start",
            whisply_protocol::protocol::HookEventName::SubagentStop => "subagent-stop",
            whisply_protocol::protocol::HookEventName::Stop => "stop",
        }
    }
}
...
impl ClaudeHooksEngine {
    ...
    async fn maybe_spill_prompt_fragments(
        &self,
        session_id: ThreadId,
        fragments: Vec<whisply_protocol::items::HookPromptFragment>,
    ) -> Vec<whisply_protocol::items::HookPromptFragment> {
        self.output_spiller
