...
use whisply_core_plugins::TrustedPluginRoots;
...
pub struct TurnContext {
    ...
    /// Opaque owner-issued native capability admission for this exact turn.
    /// It is absent unless the user explicitly approved a retained owner.
    pub(crate) first_party_tool_admission: Option<FirstPartyToolAdmission>,
    pub(crate) turn_metadata_state: Arc<TurnMetadataState>,
    pub(crate) extension_data: Arc<whisply_extension_api::ExtensionData>,
...
impl TurnContext {
    ...
    pub(crate) async fn with_model(
        ...
        Self {
            ...
            first_party_tool_admission: self.first_party_tool_admission.clone(),
...
impl Session {
    ...
    pub(crate) fn make_turn_context(
        ...
        let unified_exec_shell_mode = UnifiedExecShellMode::for_session(
            whisply_tools::unified_exec_feature_mode_for_features(per_turn_config.features.get()),
        ...
        let extension_data = Arc::new(whisply_extension_api::ExtensionData::new(sub_id.clone()));
    ...
    pub(crate) async fn new_turn_with_sub_id(
        ...
        let first_party_tool_admission = self.pending_first_party_tool_admissions.take(&sub_id);
    ...
    pub(crate) async fn maybe_emit_model_warnings_for_turn(&self, tc: &TurnContext) {
        ...
        if !tc.code_mode_available
            && matches!(
                ...
                whisply_protocol::openai_models::ToolMode::CodeMode
                    | whisply_protocol::openai_models::ToolMode::CodeModeOnly
            )
