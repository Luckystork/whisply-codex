...
use tracing::warn;
use whisply_memories_read::citations::parse_memory_citation;
use whisply_memories_read::citations::thread_ids_from_memory_citation;
use whisply_protocol::error::CodexErr;
use whisply_protocol::error::Result;
use whisply_protocol::memory_citation::MemoryCitation;
...
use whisply_utils_stream_parser::strip_proposed_plan_blocks;
...
fn strip_hidden_assistant_markup_and_parse_memory_citation(
    ...
    String,
    Option<whisply_protocol::memory_citation::MemoryCitation>,
) {
        ...
        && role == "assistant"
    {
        let combined = content
            ...
            .filter_map(|ci| match ci {
                whisply_protocol::models::ContentItem::OutputText { text } => Some(text.as_str()),
                _ => None,
            })
            .collect::<String>();
            ...
            TurnItem::AgentMessage(agent_message) => {
                let combined = agent_message
                    ...
                    .map(|entry| match entry {
                        whisply_protocol::items::AgentMessageContent::Text { text } => {
                            text.as_str()
                        }
                    })
                    .collect::<String>();
...
pub(crate) async fn finalize_turn_item(
    ...
    if let TurnItem::AgentMessage(agent_message) = &mut *turn_item {
        ...
        agent_message.content =
            vec![whisply_protocol::items::AgentMessageContent::Text { text: stripped }];
