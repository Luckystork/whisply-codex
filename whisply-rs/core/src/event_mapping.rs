...
use whisply_protocol::items::WebSearchItem;
...
use whisply_protocol::models::is_audio_close_tag_text;
use whisply_protocol::models::is_audio_open_tag_text;
use whisply_protocol::models::is_image_close_tag_text;
use whisply_protocol::models::is_image_open_tag_text;
use whisply_protocol::models::is_local_audio_close_tag_text;
use whisply_protocol::models::is_local_audio_open_tag_text;
use whisply_protocol::models::is_local_image_close_tag_text;
use whisply_protocol::models::is_local_image_open_tag_text;
use whisply_protocol::protocol::APPS_INSTRUCTIONS_OPEN_TAG;
use whisply_protocol::protocol::COLLABORATION_MODE_OPEN_TAG;
use whisply_protocol::protocol::CONTEXT_WINDOW_GUIDANCE_OPEN_TAG;
use whisply_protocol::protocol::CONTEXT_WINDOW_OPEN_TAG;
use whisply_protocol::protocol::ENVIRONMENTS_INSTRUCTIONS_OPEN_TAG;
use whisply_protocol::protocol::MULTI_AGENT_MODE_OPEN_TAG;
use whisply_protocol::protocol::PLUGINS_INSTRUCTIONS_OPEN_TAG;
use whisply_protocol::protocol::REALTIME_CONVERSATION_OPEN_TAG;
use whisply_protocol::protocol::SKILLS_INSTRUCTIONS_OPEN_TAG;
use whisply_protocol::protocol::TOOLS_OPEN_TAG;
...
pub fn parse_turn_item(item: &ResponseItem) -> Option<TurnItem> {
    match item {
        ...
        ResponseItem::ImageGenerationCall {
            ...
            whisply_protocol::items::ImageGenerationItem {
