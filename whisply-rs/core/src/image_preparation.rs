...
use tracing::warn;
use whisply_analytics::ImageDetailSetting;
...
use whisply_utils_image::PromptImageResizeLimits;
use whisply_utils_image::load_data_url_for_prompt;
...
impl ImagePreparationError {
    fn placeholder(&self) -> &'static str {
        match self {
            ...
            ImagePreparationError::Processing(
