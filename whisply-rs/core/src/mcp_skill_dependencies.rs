...
use whisply_config::load_global_mcp_servers;
use whisply_login::default_client::is_first_party_originator;
...
pub(crate) async fn maybe_prompt_and_install_mcp_dependencies(
    ...
    if mentioned_skills.is_empty()
        || !config
            .features
            .enabled(whisply_features::Feature::SkillMcpDependencyInstall)
    {
        return;
    }
