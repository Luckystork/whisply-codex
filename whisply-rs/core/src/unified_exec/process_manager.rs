...
use whisply_protocol::protocol::TerminalInteractionEvent;
...
fn exec_server_env_for_request(
    ...
    Option<whisply_exec_server::ExecEnvPolicy>,
    HashMap<String, String>,
) {
...
fn exec_server_params_for_request(
    ...
    tty: bool,
) -> whisply_exec_server::ExecParams {
...
impl UnifiedExecProcessManager {
    ...
    pub(crate) async fn open_session_with_exec_env(
        ...
        network_proxy_launch: Option<whisply_network_proxy::RemoteNetworkProxyLaunchConfig>,
    ...
    pub(crate) async fn open_session_with_prepared_exec_env(
        ...
        let network_proxy_restricting_sid = {
            ...
            {
                if request.sandbox == whisply_sandboxing::SandboxType::WindowsRestrictedToken {
                    request
                        .network
                        .as_ref()
                        .map(|network| {
        ...
        let windows_sandbox =
            if request.sandbox == whisply_sandboxing::SandboxType::WindowsRestrictedToken {
                Some(whisply_sandboxing::WindowsSandboxSpawnRequest {
        ...
        let spawn_result = whisply_sandboxing::spawn_process(whisply_sandboxing::SpawnRequest {
