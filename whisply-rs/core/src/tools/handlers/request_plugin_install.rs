...
use tracing::warn;
use whisply_analytics::PluginInstallRequestSource;
use whisply_analytics::PluginInstallRequested;
use whisply_analytics::PluginInstallRequestedPlugin;
...
use whisply_tools::DiscoverableToolAction;
use whisply_tools::DiscoverableToolType;
use whisply_tools::LIST_AVAILABLE_PLUGINS_TO_INSTALL_TOOL_NAME;
use whisply_tools::REQUEST_PLUGIN_INSTALL_PERSIST_ALWAYS_VALUE;
use whisply_tools::REQUEST_PLUGIN_INSTALL_PERSIST_KEY;
use whisply_tools::REQUEST_PLUGIN_INSTALL_TOOL_NAME;
use whisply_tools::RequestPluginInstallArgs;
use whisply_tools::RequestPluginInstallResult;
use whisply_tools::ToolName;
use whisply_tools::ToolSpec;
use whisply_tools::all_requested_connectors_picked_up;
use whisply_tools::build_request_plugin_install_elicitation_request;
use whisply_tools::filter_request_plugin_install_discoverable_tools_for_client;
use whisply_tools::verified_connector_install_completed;
...
async fn persist_disabled_install_request(
    codex_home: &whisply_utils_absolute_path::AbsolutePathBuf,
    tool: &DiscoverableTool,
) -> anyhow::Result<()> {
