...
use whisply_apply_patch::MaybeApplyPatchVerified;
...
async fn invocation_for_payload(payload: ToolPayload) -> ToolInvocation {
    ...
    ToolInvocation {
        ...
        tool_name: whisply_tools::ToolName::plain("apply_patch"),
...
*** End Patch"#;
    ...
    let action = match whisply_apply_patch::maybe_parse_apply_patch_verified(
        &argv,
        &cwd,
        LOCAL_FS.as_ref(),
        /*sandbox*/ None,
