...
use whisply_tools::ToolSearchSourceInfo;
use whisply_tools::ToolSpec;
use whisply_tools::default_namespace_description;
use whisply_tools::dynamic_tool_to_responses_api_tool;
    ...
    fn search_info(&self) -> Option<ToolSearchInfo> {
        ToolSearchInfo::from_tool_spec(
            ...
            Some(ToolSearchSourceInfo {
                ...
                description: Some("Tools provided by the current Whisply thread.".to_string()),
            }),
        )
    }
