...
use whisply_extension_api::ResponsesApiTool;
use whisply_extension_api::ToolCall as ExtensionToolCall;
...
impl whisply_extension_api::ToolContributor for ExtensionEchoContributor {
    fn tools(
        &self,
...
impl ToolExecutor<ExtensionToolCall> for ExtensionEchoExecutor {
    ...
    fn spec(&self) -> ToolSpec {
        ToolSpec::Namespace(ResponsesApiNamespace {
            ...
            tools: vec![ResponsesApiNamespaceTool::Function(ResponsesApiTool {
                ...
                strict: true,
                parameters: whisply_extension_api::parse_tool_input_schema(&json!({
                    "type": "object",
                    "properties": {
                        "message": { "type": "string" },
                    },
    ...
    fn handle(&self, call: ExtensionToolCall) -> whisply_tools::ToolExecutorFuture<'_> {
...
impl ExtensionEchoExecutor {
    async fn handle_call(
        ...
        Ok(Box::new(whisply_tools::JsonToolOutput::new(json!({
            "arguments": arguments,
            "callId": call.call_id,
...
fn mcp_runtime(tool_info: whisply_mcp::ToolInfo) -> RegisteredTool {
...
async fn extension_tool_executors_are_model_visible_and_dispatchable() -> anyhow::Result<()> {
    ...
    let router = test_tool_router(
        ...
        extension_tool_executors(
            &session,
            &whisply_extension_api::ExtensionData::new(turn.sub_id.clone()),
        ),
        &turn.dynamic_tools,
    );
