...
) -> whisply_tools::ToolUserShellType {
    match user_shell.shell_type {
        crate::shell::ShellType::Zsh => whisply_tools::ToolUserShellType::Zsh,
        crate::shell::ShellType::Bash => whisply_tools::ToolUserShellType::Bash,
        crate::shell::ShellType::PowerShell => whisply_tools::ToolUserShellType::PowerShell,
        crate::shell::ShellType::Sh => whisply_tools::ToolUserShellType::Sh,
        crate::shell::ShellType::Cmd => whisply_tools::ToolUserShellType::Cmd,
    }
}
