...
use whisply_code_mode::CodeModeSession;
...
use whisply_utils_audio::estimate_audio_token_count;
use whisply_utils_output_truncation::TruncationPolicy;
use whisply_utils_output_truncation::formatted_truncate_text_content_items_with_policy;
use whisply_utils_output_truncation::truncate_function_output_items_with_policy;
...
pub(crate) const PUBLIC_TOOL_NAME: &str = whisply_code_mode::PUBLIC_TOOL_NAME;
pub(crate) const WAIT_TOOL_NAME: &str = whisply_code_mode::WAIT_TOOL_NAME;
pub(crate) const DEFAULT_WAIT_YIELD_TIME_MS: u64 = whisply_code_mode::DEFAULT_WAIT_YIELD_TIME_MS;
...
impl CodeModeService {
    ...
    pub(crate) async fn execute(
        &self,
        mut request: whisply_code_mode::ExecuteRequest,
    ) -> Result<whisply_code_mode::StartedCell, String> {
    ...
    ) -> Result<whisply_code_mode::WaitOutcome, String> {
    ...
    pub(crate) fn mark_cell_ready_for_dispatch(&self, cell_id: &whisply_code_mode::CellId) {
...
async fn call_nested_tool(
    ...
    exec.session
        ...
        .track_code_mode_tool_call(whisply_analytics::CodeModeToolCallFact::ChildStarted {
