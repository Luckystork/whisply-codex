...
use whisply_protocol::openai_models::CollaborationModeMessages;
use whisply_protocol::openai_models::ModelMessages;
use whisply_protocol::openai_models::ModelsResponse;
use whisply_protocol::protocol::COLLABORATION_MODE_CLOSE_TAG;
            ...
            thread_settings: whisply_protocol::protocol::ThreadSettingsOverrides {
                ...
                summary: Some(
                    test.config
                        ...
                        .unwrap_or(whisply_protocol::config_types::ReasoningSummary::Auto),
                ),
                collaboration_mode: Some(collaboration_mode),
                ..Default::default()
            },
