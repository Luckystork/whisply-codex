...
use whisply_core::WaitForEnvironmentToolConfig;
use whisply_core::compact::SUMMARIZATION_PROMPT;
use whisply_core::config::Config;
use whisply_core::config::Constrained;
use whisply_exec_server::CopyOptions;
use whisply_exec_server::CreateDirectoryOptions;
use whisply_exec_server::EnvironmentReadyInfo;
use whisply_exec_server::ExecServerError;
...
use whisply_exec_server::NoiseChannelPublicKey;
use whisply_exec_server::NoiseRendezvousConnectBundle;
use whisply_exec_server::NoiseRendezvousConnectProvider;
use whisply_exec_server::REMOTE_ENVIRONMENT_ID;
use whisply_exec_server::RemoteEnvironmentConfig;
use whisply_exec_server::RemoveOptions;
use whisply_extension_api::ContextContributor;
...
use whisply_extension_api::ThreadLifecycleContributor;
...
use whisply_protocol::models::SandboxPermissions;
...
use whisply_protocol::protocol::ENVIRONMENTS_INSTRUCTIONS_OPEN_TAG;
...
async fn submit_turn_with_approval_and_environments(
    ...
    let turn_environment_selections = whisply_protocol::protocol::TurnEnvironmentSelections::new(
...
-> Result<()> {
    ...
    let remote_environment = tokio::spawn(whisply_exec_server::run_remote_environment(
        remote_config,
        runtime_paths,
    ));
