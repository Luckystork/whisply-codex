...
use whisply_api::WS_REQUEST_HEADER_TRACEPARENT_CLIENT_METADATA_KEY;
use whisply_api::WS_REQUEST_HEADER_TRACESTATE_CLIENT_METADATA_KEY;
use whisply_core::CodexResponsesMetadata;
use whisply_core::ModelClient;
use whisply_core::ModelClientSession;
use whisply_core::Prompt;
use whisply_core::ResponseEvent;
use whisply_core::X_RESPONSESAPI_INCLUDE_TIMING_METRICS_HEADER;
use whisply_core::test_support::with_parent_turn;
...
use whisply_rollout_trace::ConversationPart;
use whisply_rollout_trace::InferenceTraceContext;
use whisply_rollout_trace::RawTraceEventPayload;
use whisply_rollout_trace::TraceWriter;
...
async fn responses_websocket_streams_request() {
    ...
    assert_eq!(
        ...
        Some(whisply_login::default_client::get_codex_user_agent())
    );
    assert_eq!(
...
async fn websocket_harness_with_provider_options(
    ...
    let model_info = whisply_core::test_support::construct_model_info_offline(MODEL, &config);
