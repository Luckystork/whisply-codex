//! Helpers for truncating tool and exec output using [`TruncationPolicy`](whisply_protocol::protocol::TruncationPolicy).

use whisply_protocol::models::FunctionCallOutputContentItem;
pub use whisply_utils_string::approx_bytes_for_tokens;
pub use whisply_utils_string::approx_token_count;
pub use whisply_utils_string::approx_tokens_from_byte_count;
use whisply_utils_string::truncate_middle_chars;
use whisply_utils_string::truncate_middle_with_token_budget;

pub use whisply_protocol::protocol::TruncationPolicy;
