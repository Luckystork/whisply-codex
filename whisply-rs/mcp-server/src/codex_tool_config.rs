...
impl CodexToolCallParam {
    ...
    pub async fn into_config(
        ...
        // Build the `ConfigOverrides` recognized by whisply-core.
          ...
          "inputSchema": {
            ...
            "properties": {
              ...
              "config": {
                ...
                "description": "Individual config settings that will override what is in WHISPLY_HOME/config.toml.",
                "type": "object"
              },
              "cwd": {
