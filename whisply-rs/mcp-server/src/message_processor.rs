...
use whisply_login::default_client::USER_AGENT_SUFFIX;
...
impl MessageProcessor {
    ...
    pub(crate) async fn new(
        ...
        whisply_git_attribution::install(
            &mut extensions,
            auth_manager.clone(),
            config.chatgpt_base_url.clone(),
            config.http_client_factory(),
        );
        whisply_image_generation_extension::install(
            &mut extensions,
            auth_manager.clone(),
        ...
        let thread_manager = Arc::new(ThreadManager::new(
            ...
            whisply_core::build_models_manager(config.as_ref(), auth_manager),
    ...
    async fn handle_cancelled_notification(&self, params: rmcp::model::CancelledNotificationParam) {
        ...
        if codex_arc
            .submit_with_id(Submission {
                ...
                op: whisply_protocol::protocol::Op::Interrupt,
