...
use whisply_agent_identity::authorization_header_for_agent_task;
...
use whisply_login::auth::AgentIdentityAuthError;
...
pub(crate) fn resolve_provider_auth(
    ...
    provider: &ModelProviderInfo,
) -> whisply_protocol::error::Result<SharedAuthProvider> {
...
) -> whisply_protocol::error::Result<ResolvedProviderAuth> {
...
fn bearer_auth_for_provider(
    provider: &ModelProviderInfo,
) -> whisply_protocol::error::Result<Option<BearerAuthProvider>> {
...
mod tests {
    ...
    use whisply_login::auth::login_with_chatgpt_auth_tokens;
