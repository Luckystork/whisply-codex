...
use whisply_login::collect_auth_env_telemetry;
use whisply_login::default_client::create_client_for_route_async;
...
impl OpenAiModelsEndpoint {
    ...
    async fn list_models(
        ...
        let _timer =
            whisply_otel::start_global_timer("codex.remote_models.fetch_update.duration_ms", &[]);
