...
use whisply_aws_auth::AwsAuthContext;
use whisply_aws_auth::AwsAuthError;
use whisply_aws_auth::AwsRequestToSign;
use whisply_http_client::Request;
use whisply_http_client::RequestBody;
use whisply_http_client::RequestCompression;
