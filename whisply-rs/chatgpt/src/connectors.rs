...
use whisply_connectors::ConnectorDirectoryCacheContext;
use whisply_connectors::ConnectorDirectoryCacheKey;
use whisply_connectors::ConnectorMetadata;
use whisply_connectors::ConnectorMetadataStore;
use whisply_connectors::ConnectorToolSummary;
use whisply_connectors::DirectoryListResponse;
use whisply_connectors::merge::merge_connectors;
use whisply_connectors::merge::merge_plugin_connectors;
use whisply_core::config::Config;
pub use whisply_core::connectors::list_accessible_connectors_from_mcp_tools;
pub use whisply_core::connectors::list_accessible_connectors_from_mcp_tools_with_environment_manager;
pub use whisply_core::connectors::list_accessible_connectors_from_mcp_tools_with_mcp_manager;
pub use whisply_core::connectors::list_accessible_connectors_from_mcp_tools_with_options;
pub use whisply_core::connectors::list_accessible_connectors_from_mcp_tools_with_options_and_status;
pub use whisply_core::connectors::list_cached_accessible_connectors_from_mcp_tools;
...
pub async fn list_cached_all_connectors(
    ...
    let connectors = whisply_connectors::cached_directory_connectors(&cache_context)?;
...
pub async fn list_all_connectors_with_options(
    ...
    let cache_context = connector_directory_cache_context(config, &auth);
    let connectors = whisply_connectors::list_all_connectors_with_options(
        cache_context,
...
pub async fn read_connector_metadata(
    ...
    anyhow::ensure!(
        ...
        "ChatGPT account ID not available, please re-run whisply login"
    );
...
mod tests {
    ...
    use serde_json::json;
    use whisply_connectors::metadata::connector_install_url;
    use whisply_plugin::AppConnectorId;
