...
use whisply_external_agent_migration::ExternalAgentConfigImportItemResult;
use whisply_external_agent_migration::record_import_error;
use whisply_external_agent_migration::sessions::CompletedExternalAgentSessionImport;
use whisply_external_agent_migration::sessions::ExistingSessionAppend;
use whisply_external_agent_migration::sessions::ExternalAgentSessionMigration;
use whisply_external_agent_migration::sessions::ImportedExternalAgentSession;
use whisply_external_agent_migration::sessions::ImportedSessionConnectorAttribution;
use whisply_external_agent_migration::sessions::PendingSessionImport;
use whisply_external_agent_migration::sessions::SessionImportTarget;
use whisply_external_agent_migration::sessions::SessionMetadataMode;
use whisply_external_agent_migration::sessions::append_existing_session;
use whisply_external_agent_migration::sessions::append_imported_session_connector_names;
use whisply_external_agent_migration::sessions::detect_imported_cla_session_connectors_by_source_path;
use whisply_external_agent_migration::sessions::prepare_validated_session_import_with_metadata_mode;
use whisply_external_agent_migration::sessions::record_completed_session_imports;
...
use whisply_thread_store::AppendThreadItemsParams;
...
impl ExternalAgentSessionImporter {
    ...
    async fn persist_session(
        ...
        let create_params = CreateThreadParams {
            ...
            source: source.clone(),
            thread_source: None,
            originator: whisply_login::default_client::originator().value,
