...
use whisply_external_agent_migration::DetectedConnectorCandidate as CoreDetectedConnectorCandidate;
use whisply_external_agent_migration::DetectedConnectorSource as CoreDetectedConnectorSource;
use whisply_external_agent_migration::ExternalAgentConfigImportItemResult as CoreImportItemResult;
use whisply_external_agent_migration::ExternalAgentConfigImportRawError as CoreImportRawError;
use whisply_external_agent_migration::ExternalAgentConfigImportSuccess;
use whisply_external_agent_migration::ExternalAgentConfigMigrationItem as CoreMigrationItem;
use whisply_external_agent_migration::ExternalAgentConfigMigrationItemType as CoreMigrationItemType;
use whisply_external_agent_migration::MigrationDetails as CoreMigrationDetails;
use whisply_external_agent_migration::NamedMigration;
use whisply_external_agent_migration::PluginsMigration as CorePluginsMigration;
...
pub(super) fn protocol_import_history(
    record: whisply_state::ExternalAgentConfigImportHistoryRecord,
