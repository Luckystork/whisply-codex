...
use whisply_app_server::AppServerCodeModeHostArgs;
use whisply_app_server::AppServerRuntimeOptions;
use whisply_app_server::AppServerTransport;
use whisply_app_server::AppServerWebsocketAuthArgs;
use whisply_app_server::PluginStartupTasks;
use whisply_app_server::run_main_with_transport_options;
    ...
    arg0_dispatch_or_else(move |arg0_paths: Arg0DispatchPaths| async move {
        ...
        runtime_options.remote_control_startup_mode =
            match (remote_control, remote_control_disabled) {
                (true, _) => whisply_app_server::RemoteControlStartupMode::EnabledEphemeral,
                (false, true) => whisply_app_server::RemoteControlStartupMode::DisabledEphemeral,
                (false, false) => whisply_app_server::RemoteControlStartupMode::ResolvePersisted,
            };
