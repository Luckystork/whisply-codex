...
use whisply_utils_json_to_toml::json_to_toml;
...
impl ConfigManager {
    ...
    fn current_thread_config_loader(&self) -> Arc<dyn ThreadConfigLoader> {
        self.thread_config_loader
            ...
            .unwrap_or_else(|_| Arc::new(whisply_config::NoopThreadConfigLoader))
    }
    ...
    pub(crate) async fn load_with_cli_overrides(
        ...
        let mut config = whisply_core::config::ConfigBuilder::default()
            .codex_home(self.codex_home.clone())
