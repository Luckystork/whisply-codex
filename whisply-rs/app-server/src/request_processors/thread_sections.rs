...
use whisply_thread_store::CreateThreadSectionParams as StoreCreateThreadSectionParams;
use whisply_thread_store::DeleteThreadSectionParams as StoreDeleteThreadSectionParams;
use whisply_thread_store::ListThreadSectionsParams as StoreListThreadSectionsParams;
use whisply_thread_store::RenameThreadSectionParams as StoreRenameThreadSectionParams;
...
fn thread_section_store_error(
    ...
    match error {
        ...
        error @ (ThreadStoreError::StorageFull
