...
use whisply_connectors::AppBranding;
use whisply_connectors::AppInfo;
use whisply_connectors::AppMetadata;
use whisply_connectors::AppReview;
use whisply_connectors::AppScreenshot;
...
/// Converts connector-domain app metadata owned by `whisply-connectors` into the app-server wire
