...
use whisply_protocol::protocol::SessionSource as CoreSessionSource;
...
async fn thread_list_reports_system_error_idle_flag_after_failed_turn() -> Result<()> {
    let responses = vec![
        ...
        responses::sse_failed("resp-4", "server_error", "simulated failure"),
    ];
...
"#,
    ...
    state_db
        ...
        .await?;
    let rollout_config = whisply_rollout::RolloutConfig {
        codex_home: codex_home.path().to_path_buf(),
        sqlite: whisply_state::SqliteConfig::new_for_testing(codex_home.path().abs()),
        cwd: codex_home.path().to_path_buf(),
        model_provider_id: "whisply".to_string(),
        generate_memories: false,
    };
    let repaired_page = whisply_core::RolloutRecorder::list_threads(
        Some(state_db.clone()),
        &rollout_config,
        /*page_size*/ 10,
        /*cursor*/ None,
        whisply_core::ThreadSortKey::CreatedAt,
        whisply_core::SortDirection::Desc,
        &[],
    ...
    for thread_id in [&older_match, &newer_match] {
        let request_id = mcp
            .send_thread_section_move_request(ThreadSectionMoveParams {
                ...
                section_id: Some(whisply_state::PINNED_THREAD_SECTION_ID.to_string()),
...
async fn thread_list_sort_recency_at_uses_state_db_order_with_provider_filter() -> Result<()> {
    ...
    whisply_core::RolloutRecorder::list_threads(
        Some(state_db.clone()),
        &rollout_config,
        /*page_size*/ 10,
        /*cursor*/ None,
        whisply_core::ThreadSortKey::CreatedAt,
        whisply_core::SortDirection::Desc,
        whisply_core::INTERACTIVE_SESSION_SOURCES.as_slice(),
        /*model_providers*/ None,
        /*cwd_filters*/ None,
        "whisply",
        /*search_term*/ None,
