...
async fn assert_thread_fork_freezes_active_paginated_turn_as_interrupted(
    ...
    assert!(matches!(
        ...
        [
            ...
            RolloutLine {
                item: RolloutItem::ResponseItem(whisply_protocol::models::ResponseItem::Message {
                    role,
                    ..
                }),
                ..
    ...
    drop(mcp);
    let mut resumed_app_server =
        app_test_support::managed_whisply_app_server_builder!(&server.uri())
            .with_codex_home(codex_home.path())
            .without_auto_env()
            .build_initialized()
            .await?;
