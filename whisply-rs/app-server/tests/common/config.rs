...
/// The native broker writes this account-scoped value before it starts the
/// shipped runtime. Managed child fixtures need the same non-secret binding so
/// signed catalog requests exercise the production header contract.
const TEST_INSTALLATION_ID: &str = "70000000-0000-4000-8000-000000000001";
