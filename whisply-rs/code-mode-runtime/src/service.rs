...
use whisply_code_mode_protocol::CodeModeSession;
use whisply_code_mode_protocol::CodeModeSessionCellExecutionLimits;
use whisply_code_mode_protocol::CodeModeSessionDelegate;
use whisply_code_mode_protocol::CodeModeSessionResultFuture;
use whisply_code_mode_protocol::CodeModeToolKind;
use whisply_code_mode_protocol::DEFAULT_EXEC_YIELD_TIME_MS;
use whisply_code_mode_protocol::ExecuteRequest;
use whisply_code_mode_protocol::ExecuteToPendingOutcome;
use whisply_code_mode_protocol::FunctionCallOutputContentItem;
use whisply_code_mode_protocol::ImageDetail;
use whisply_code_mode_protocol::NoopCodeModeSessionDelegate;
...
use whisply_code_mode_protocol::WaitToPendingOutcome;
use whisply_code_mode_protocol::WaitToPendingRequest;
        ...
        self.delegate
            .invoke_tool(
                CodeModeNestedToolCall {
                    ...
                    tool_name: whisply_protocol::ToolName {
