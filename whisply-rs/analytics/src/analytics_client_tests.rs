...
use tokio::sync::mpsc;
use whisply_login::default_client::DEFAULT_ORIGINATOR;
...
use whisply_protocol::models::PermissionProfile as CorePermissionProfile;
...
async fn analytics_flush_delivers_completed_turn_with_file_diff() {
    ...
    let auth_manager = whisply_login::AuthManager::from_auth_for_testing(
        whisply_login::CodexAuth::create_dummy_chatgpt_auth_for_testing(),
    );
...
async fn compaction_event_ingests_custom_fact() {
    ...
    let parent_thread_id =
        whisply_protocol::ThreadId::from_string("22222222-2222-2222-2222-222222222222")
        ...
        .ingest(
            AnalyticsFact::Custom(CustomAnalyticsFact::GuardianReview(Box::new(
                GuardianReviewEventParams {
                    ...
                    guardian_policy_revision: Some("sha256:0123456789abcdef".to_string()),
...
fn subagent_thread_started_thread_spawn_serializes_thread_lineage() {
    let parent_thread_id =
        whisply_protocol::ThreadId::from_string("11111111-1111-1111-1111-111111111111")
            .expect("valid thread id");
    let forked_from_thread_id =
        whisply_protocol::ThreadId::from_string("22222222-2222-4222-8222-222222222222")
            .expect("valid thread id");
    let event = TrackEventRequest::ThreadInitialized(subagent_thread_started_event_request(
        SubAgentThreadStartedInput {
            session_id: "session-root".to_string(),
...
fn subagent_thread_started_other_serializes_explicit_parent_thread_id() {
    let parent_thread_id =
        whisply_protocol::ThreadId::from_string("33333333-3333-4333-8333-333333333333")
            .expect("valid thread id");
    let event = TrackEventRequest::ThreadInitialized(subagent_thread_started_event_request(
        SubAgentThreadStartedInput {
            session_id: "session-root".to_string(),
...
async fn subagent_events_keep_thread_originator_with_explicit_turn_connection() {
    ...
    let mut events = Vec::new();
    let parent_thread_id =
        whisply_protocol::ThreadId::from_string("44444444-4444-4444-4444-444444444444")
            .expect("valid parent thread id");
        ...
        .ingest(
            AnalyticsFact::Custom(CustomAnalyticsFact::SkillInvoked(SkillInvokedInput {
                ...
                invocations: vec![SkillInvocation {
                    ...
                    skill_scope: whisply_protocol::protocol::SkillScope::User,
                    skill_path,
                    plugin_id: None,
