...
use whisply_code_mode_protocol::CodeModeSessionProvider;
use whisply_code_mode_protocol::ExecuteRequest;
use whisply_code_mode_protocol::FunctionCallOutputContentItem;
use whisply_code_mode_protocol::RuntimeResponse;
...
use whisply_code_mode_protocol::host::WireCellId;
...
async fn websocket_provider_executes_over_shared_connector() {
    ...
    assert_eq!(
        ...
        RuntimeResponse::Result {
            cell_id: whisply_code_mode_protocol::CellId::new("1".to_string()),
...
async fn shutdown_before_open_does_not_spawn_the_host() {
    ...
    let error = session
        .execute(whisply_code_mode_protocol::ExecuteRequest {
