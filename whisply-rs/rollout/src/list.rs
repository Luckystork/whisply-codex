...
use whisply_file_search as file_search;
...
pub struct ThreadItem {
    ...
    pub section: Option<whisply_state::ThreadSection>,
...
impl From<whisply_state::Anchor> for Cursor {
    fn from(anchor: whisply_state::Anchor) -> Self {
        let ts = anchor
            .ts
            .timestamp_nanos_opt()
...
async fn find_thread_path_by_id_str_in_subdir(
    ...
    subdir: &str,
    id_str: &str,
    state_db_ctx: Option<&whisply_state::StateRuntime>,
