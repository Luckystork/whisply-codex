...
use whisply_state::BackfillState;
use whisply_state::BackfillStats;
use whisply_state::BackfillStatus;
use whisply_state::DB_ERROR_METRIC;
use whisply_state::DB_METRIC_BACKFILL;
use whisply_state::DB_METRIC_BACKFILL_DURATION_MS;
use whisply_state::ExtractionOutcome;
use whisply_state::ThreadMetadataBuilder;
use whisply_state::apply_rollout_item;
...
pub(crate) async fn backfill_sessions_with_lease(
    ...
    let metric_client = whisply_otel::global();
