...
#[test]
fn storage_full_maps_to_protocol_and_fails_the_turn() {
    let err = CodexErr::StorageFull;
    assert_eq!(err.to_codex_protocol_error(), CodexErrorInfo::StorageFull);
    assert!(CodexErrorInfo::StorageFull.affects_turn_status());
}
