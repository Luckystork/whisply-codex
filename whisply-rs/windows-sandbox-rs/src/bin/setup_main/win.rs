...
use std::sync::mpsc;
use whisply_otel::StatsigMetricsSettings;
use whisply_windows_sandbox::SETUP_VERSION;
use whisply_windows_sandbox::SetupErrorCode;
use whisply_windows_sandbox::SetupErrorReport;
use whisply_windows_sandbox::SetupFailure;
use whisply_windows_sandbox::add_deny_write_ace;
use whisply_windows_sandbox::convert_string_sid_to_sid;
use whisply_windows_sandbox::ensure_allow_mask_aces_with_inheritance;
use whisply_windows_sandbox::ensure_allow_write_aces;
use whisply_windows_sandbox::extract_setup_failure;
use whisply_windows_sandbox::hide_newly_created_users;
use whisply_windows_sandbox::install_wfp_filters;
use whisply_windows_sandbox::log_note;
use whisply_windows_sandbox::log_writer;
use whisply_windows_sandbox::path_mask_allows;
use whisply_windows_sandbox::path_write_aces_need_refresh;
use whisply_windows_sandbox::sandbox_bin_dir;
use whisply_windows_sandbox::sandbox_dir;
use whisply_windows_sandbox::sandbox_secrets_dir;
use whisply_windows_sandbox::string_from_sid_bytes;
use whisply_windows_sandbox::sync_persistent_deny_read_acls;
use whisply_windows_sandbox::to_wide;
use whisply_windows_sandbox::workspace_write_cap_sid_for_root;
use whisply_windows_sandbox::workspace_write_root_overlaps_path;
use whisply_windows_sandbox::write_setup_error_report;
...
mod tests {
    ...
    use std::fs;
    use whisply_otel::StatsigMetricsSettings;
    use whisply_windows_sandbox::ensure_allow_mask_aces;
    use whisply_windows_sandbox::ensure_allow_write_aces;
    use whisply_windows_sandbox::load_or_create_cap_sids;
    use whisply_windows_sandbox::path_mask_allows;
    use whisply_windows_sandbox::path_write_aces_need_refresh;
    use whisply_windows_sandbox::workspace_write_cap_sid_for_root;
    use windows_sys::Win32::Foundation::HLOCAL;
