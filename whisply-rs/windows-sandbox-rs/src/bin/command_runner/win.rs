...
use whisply_utils_pty::JobObject;
use whisply_windows_sandbox::ConsoleMode;
use whisply_windows_sandbox::ErrorPayload;
use whisply_windows_sandbox::ErrorStage;
use whisply_windows_sandbox::ExitPayload;
use whisply_windows_sandbox::FramedMessage;
use whisply_windows_sandbox::IPC_PROTOCOL_VERSION;
use whisply_windows_sandbox::LocalSid;
use whisply_windows_sandbox::Message;
use whisply_windows_sandbox::OutputPayload;
use whisply_windows_sandbox::OutputStream;
use whisply_windows_sandbox::PipeSpawnHandles;
use whisply_windows_sandbox::ResizePayload;
use whisply_windows_sandbox::SpawnReady;
use whisply_windows_sandbox::SpawnRequest;
use whisply_windows_sandbox::StderrMode;
use whisply_windows_sandbox::StdinMode;
use whisply_windows_sandbox::WindowsSandboxTokenMode;
use whisply_windows_sandbox::allow_null_device;
use whisply_windows_sandbox::create_readonly_token_with_caps_and_user_from;
use whisply_windows_sandbox::create_workspace_write_token_with_caps_and_user_from;
use whisply_windows_sandbox::decode_bytes;
use whisply_windows_sandbox::encode_bytes;
use whisply_windows_sandbox::get_current_token_for_restriction;
use whisply_windows_sandbox::hide_current_user_profile_dir;
use whisply_windows_sandbox::log_note;
use whisply_windows_sandbox::read_frame;
use whisply_windows_sandbox::read_handle_loop;
use whisply_windows_sandbox::spawn_process_with_pipes;
use whisply_windows_sandbox::to_wide;
use whisply_windows_sandbox::token_mode_for_permission_profile;
use whisply_windows_sandbox::write_frame;
...
// Kept in sync with whisply_exec_server::CODEX_FS_HELPER_ARG1 without introducing
// a dependency cycle.
...
struct IpcSpawnedProcess {
    ...
    conpty_owner: Option<whisply_windows_sandbox::ConptyInstance>,
...
fn spawn_ipc_process(req: &SpawnRequest) -> Result<IpcSpawnedProcess> {
    ...
    let (pi, job, stdout_handle, stderr_handle, stdin_handle) = if req.tty {
        let (pi, mut conpty) = whisply_windows_sandbox::spawn_conpty_process_as_user(
            h_token.raw(),
            &req.command,
            &effective_cwd,
            &req.env,
