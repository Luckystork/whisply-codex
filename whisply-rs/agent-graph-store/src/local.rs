...
fn to_state_status(
    status: ThreadSpawnEdgeStatus,
) -> whisply_state::DirectionalThreadSpawnEdgeStatus {
    match status {
        ThreadSpawnEdgeStatus::Open => whisply_state::DirectionalThreadSpawnEdgeStatus::Open,
        ThreadSpawnEdgeStatus::Closed => whisply_state::DirectionalThreadSpawnEdgeStatus::Closed,
    }
}
