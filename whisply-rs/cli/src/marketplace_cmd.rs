...
use whisply_core_plugins::PluginMarketplaceUpgradeOutcome;
...
use whisply_core_plugins::marketplace::marketplace_root_dir;
use whisply_core_plugins::marketplace_add::MarketplaceAddOutcome;
use whisply_core_plugins::marketplace_add::MarketplaceAddRequest;
use whisply_core_plugins::marketplace_add::add_marketplace;
use whisply_core_plugins::marketplace_remove::MarketplaceRemoveOutcome;
use whisply_core_plugins::marketplace_remove::MarketplaceRemoveRequest;
...
#[derive(Debug, Parser)]
#[command(bin_name = "whisply plugin marketplace")]
...
enum MarketplaceSubcommand {
    ...
    /// List plugin marketplaces Whisply is currently considering and their roots.
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "whisply plugin marketplace add",
    after_help = "Examples:\n  whisply plugin marketplace add ./path/to/marketplace\n  whisply plugin marketplace add owner/repo --ref main\n  whisply plugin marketplace add https://github.com/owner/repo --sparse plugins/foo"
)]
...
#[derive(Debug, Parser)]
#[command(bin_name = "whisply plugin marketplace list")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "whisply plugin marketplace upgrade",
    after_help = "Examples:\n  whisply plugin marketplace upgrade\n  whisply plugin marketplace upgrade debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "whisply plugin marketplace remove",
    after_help = "Example:\n  whisply plugin marketplace remove debug"
)]
...
impl JsonMarketplaceListOutput {
    fn from_marketplaces(
        marketplaces: Vec<whisply_core_plugins::marketplace::Marketplace>,
