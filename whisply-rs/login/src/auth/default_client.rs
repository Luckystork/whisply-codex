...
//!
//! Use [`crate::default_client`] or [`whisply_login::default_client`] from other crates in this
//! workspace.
...
use std::sync::Mutex;
use std::sync::RwLock;
use whisply_http_client::BuildRouteAwareHttpClientError;
...
pub use whisply_http_client::RequestBuilder as CodexRequestBuilder;
...
pub use whisply_config::ResidencyRequirement;
