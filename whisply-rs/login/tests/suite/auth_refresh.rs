...
use whisply_login::CLIENT_ID_OVERRIDE_ENV_VAR;
use whisply_login::REFRESH_TOKEN_URL_OVERRIDE_ENV_VAR;
use whisply_login::RefreshTokenError;
use whisply_login::load_auth_dot_json;
use whisply_login::save_auth;
use whisply_login::token_data::IdTokenInfo;
...
async fn refresh_token_honors_respect_system_proxy() -> Result<()> {
    ...
    let auth_manager = AuthManager::shared(
        ...
        /*auth_route_config*/
        whisply_login::AuthRouteConfig::from_http_client_factory(HttpClientFactory::new(
