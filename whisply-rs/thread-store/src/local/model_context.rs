...
use whisply_rollout::ModelContextScan;
use whisply_rollout::ModelContextScanProgress;
use whisply_rollout::ReverseJsonlScanner;
use whisply_rollout::ScanOutcome;
...
pub(super) async fn load_for_fork(
    ...
    let session_meta = whisply_rollout::read_session_meta_line(source_path)
        .await
        .map_err(|err| ThreadStoreError::Internal {
            message: format!(
