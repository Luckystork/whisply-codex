...
use whisply_rollout::first_rollout_content_match_snippet;
use whisply_rollout::parse_cursor;
use whisply_rollout::search_rollout_matches;
...
struct ThreadSearchItem {
    item: whisply_rollout::ThreadItem,
    snippet: String,
}
...
pub(super) async fn search_threads(
    ...
    loop {
        ...
        for item in page.items {
            let logical_path = whisply_rollout::plain_rollout_path(item.path.as_path());
