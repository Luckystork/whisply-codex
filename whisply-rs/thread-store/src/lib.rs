...
//!
//! Application code should treat [`whisply_protocol::ThreadId`] as the only durable thread handle.
...
pub use whisply_state::MAX_QUEUE_ITEMS;
pub use whisply_state::QueuedUserSubmissionRecord;
