...
mod tests {
    ...
    async fn test_fetch_models_happy_path() {
        if std::env::var(whisply_core::spawn::CODEX_SANDBOX_NETWORK_DISABLED_ENV_VAR).is_ok() {
            tracing::info!(
    ...
    async fn test_try_from_provider_preserves_outbound_proxy_policy() {
        ...
        whisply_http_client::cache_system_proxy_route_for_test(&request_url, proxy.uri());
