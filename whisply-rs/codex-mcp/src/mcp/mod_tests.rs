...
pub(crate) fn test_mcp_config(codex_home: PathBuf) -> McpConfig {
    McpConfig {
        ...
        config_layer_stack: whisply_config::ConfigLayerStack::default(),
        approvals_reviewer: whisply_config::types::ApprovalsReviewer::default(),
        ...
        connector_snapshot: whisply_connectors::ConnectorSnapshot::default(),
    }
}
