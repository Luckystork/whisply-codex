...
//! `whisply-core`: this module translates the protocol surface into the smaller
//! trace vocabulary and keeps the mapping isolated inside `whisply-rollout-trace`.
//!
...
use whisply_protocol::protocol::ExecCommandStatus;
...
use whisply_protocol::protocol::PatchApplyStatus;
use whisply_protocol::protocol::SubAgentActivityEvent;
...
pub(crate) enum ToolRuntimePayload<'a> {
    ...
    CollabAgentSpawnBegin(&'a whisply_protocol::protocol::CollabAgentSpawnBeginEvent),
    CollabAgentSpawnEnd(&'a whisply_protocol::protocol::CollabAgentSpawnEndEvent),
    CollabAgentInteractionBegin(&'a whisply_protocol::protocol::CollabAgentInteractionBeginEvent),
    CollabAgentInteractionEnd(&'a whisply_protocol::protocol::CollabAgentInteractionEndEvent),
    CollabWaitingBegin(&'a whisply_protocol::protocol::CollabWaitingBeginEvent),
    CollabWaitingEnd(&'a whisply_protocol::protocol::CollabWaitingEndEvent),
    CollabCloseBegin(&'a whisply_protocol::protocol::CollabCloseBeginEvent),
    CollabCloseEnd(&'a whisply_protocol::protocol::CollabCloseEndEvent),
...
struct ExecCommandBeginTracePayload<'a> {
    ...
    command: &'a [String],
    cwd: String,
    parsed_cmd: &'a [whisply_protocol::parse_command::ParsedCommand],
