...
use uuid::Uuid;
use whisply_code_mode::CellId;
use whisply_code_mode::CodeModeNestedToolCall;
use whisply_code_mode::CodeModeSessionCellExecutionLimits;
use whisply_code_mode::CodeModeSessionDelegate;
use whisply_code_mode::CodeModeSessionProvider;
use whisply_code_mode::CodeModeToolKind;
use whisply_code_mode::ExecuteRequest;
use whisply_code_mode::FunctionCallOutputContentItem;
use whisply_code_mode::NoopCodeModeSessionDelegate;
use whisply_code_mode::NotificationFuture;
use whisply_code_mode::RuntimeResponse;
use whisply_code_mode::ToolDefinition;
use whisply_code_mode::ToolInvocationFuture;
use whisply_code_mode::WebSocketCodeModeSessionProvider;
use whisply_code_mode_protocol::host::Capability;
use whisply_code_mode_protocol::host::CapabilitySet;
use whisply_code_mode_protocol::host::ClientHello;
use whisply_code_mode_protocol::host::ClientToHost;
use whisply_code_mode_protocol::host::DUAL_WEBSOCKET_CAPABILITY;
use whisply_code_mode_protocol::host::DelegateRequest;
use whisply_code_mode_protocol::host::DelegateResponse;
use whisply_code_mode_protocol::host::EncodedFrame;
use whisply_code_mode_protocol::host::HostHello;
use whisply_code_mode_protocol::host::HostRequest;
use whisply_code_mode_protocol::host::HostResponse;
use whisply_code_mode_protocol::host::HostToClient;
use whisply_code_mode_protocol::host::MAX_FRAME_BYTES;
use whisply_code_mode_protocol::host::ProtocolVersion;
use whisply_code_mode_protocol::host::RequestId;
use whisply_code_mode_protocol::host::SESSION_RESOURCE_LIMITS_CAPABILITY;
use whisply_code_mode_protocol::host::SessionId;
use whisply_code_mode_protocol::host::SupportedProtocolVersions;
use whisply_code_mode_protocol::host::WireContentItem;
use whisply_code_mode_protocol::host::WireExecuteRequest;
use whisply_code_mode_protocol::host::WireResult;
use whisply_code_mode_protocol::host::WireRuntimeResponse;
use whisply_code_mode_protocol::host::WireToolDefinition;
use whisply_code_mode_protocol::host::WireToolKind;
use whisply_code_mode_protocol::host::WireToolName;
use whisply_code_mode_protocol::host::WireWaitRequest;
...
impl HostHarness {
    async fn start() -> Result<Self> {
        let host_program = whisply_utils_cargo_bin::cargo_bin("codex-code-mode-host")?;
...
async fn websocket_control_operations_bypass_an_incomplete_bulk_frame() -> Result<()> {
    ...
    let bulk_message = ClientToHost::DelegateResponse {
        id: whisply_code_mode_protocol::host::DelegateRequestId::new(/*value*/ 999),
        result: WireResult::Ok {
            value: DelegateResponse::ToolResult {
        ...
        .send(&ClientToHost::Request {
            ...
            request: HostRequest::Wait {
                ...
                request: WireWaitRequest {
                    cell_id: whisply_code_mode_protocol::host::WireCellId::new("missing-cell"),
                    yield_time_ms: 10,
                },
            },
        })
