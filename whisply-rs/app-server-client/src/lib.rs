...
//!
//! This crate wraps [`whisply_app_server::in_process`] behind a single async API
...
//! [`InProcessClientHandle`](whisply_app_server::in_process::InProcessClientHandle),
...
use tracing::warn;
pub use whisply_app_server::app_server_control_socket_path;
pub use whisply_app_server::in_process::DEFAULT_IN_PROCESS_CHANNEL_CAPACITY;
pub use whisply_app_server::in_process::InProcessServerEvent;
use whisply_app_server::in_process::InProcessStartArgs;
use whisply_app_server::in_process::LogDbLayer;
pub use whisply_app_server::in_process::StateDbHandle;
...
pub use whisply_core::otel_init::build_provider as build_otel_provider;
...
/// module exists so clients can remove a direct `whisply-core` dependency
/// while legacy startup/config paths are migrated to RPCs.
pub mod legacy_core {
    pub mod config {
        pub use whisply_core::config::*;

        pub mod edit {
            pub use whisply_core::config::edit::*;
        }
    }
}
...
/// - [`whisply_app_server::in_process::InProcessClientHandle`], which speaks to
...
impl InProcessAppServerClient {
    ...
    pub async fn start(args: InProcessClientStartArgs) -> IoResult<Self> {
        ...
        let mut handle =
            whisply_app_server::in_process::start(args.into_runtime_start_args()).await?;
