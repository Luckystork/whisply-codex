...
use whisply_feedback::DOCTOR_REPORT_ATTACHMENT_FILENAME;
use whisply_feedback::FEEDBACK_DIAGNOSTICS_ATTACHMENT_FILENAME;
use whisply_feedback::FeedbackDiagnostics;
    ...
    super::SelectionViewParams {
        ...
        items: vec![
            super::SelectionItem {
                name: "Yes".to_string(),
                description: Some(
                    "Share the current Whisply session logs and diagnostics with the team for troubleshooting."
                        .to_string(),
                ),
...
mod tests {
    ...
    use whisply_feedback::FeedbackDiagnostic;
