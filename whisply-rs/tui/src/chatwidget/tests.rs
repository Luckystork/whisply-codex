...
pub(super) use whisply_config::ConfigLayerStack;
pub(super) use whisply_config::Constrained;
pub(super) use whisply_config::ConstraintError;
pub(super) use whisply_config::RequirementSource;
pub(super) use whisply_config::types::ApprovalsReviewer;
pub(super) use whisply_config::types::Notifications;
pub(super) use whisply_config::types::WindowsSandboxModeToml;
pub(super) use whisply_core_plugins::OPENAI_CURATED_MARKETPLACE_NAME;
pub(super) use whisply_features::FEATURES;
pub(super) use whisply_features::Feature;
pub(super) use whisply_git_utils::CommitLogEntry;
pub(super) use whisply_models_manager::test_support::construct_model_info_offline_for_tests;
pub(super) use whisply_models_manager::test_support::get_model_offline_for_tests;
pub(super) use whisply_otel::RuntimeMetricsSummary;
pub(super) use whisply_otel::SessionTelemetry;
pub(super) use whisply_protocol::ThreadId;
pub(super) use whisply_protocol::account::PlanType;
pub(super) use whisply_protocol::approvals::GuardianAssessmentAction;
pub(super) use whisply_protocol::approvals::GuardianAssessmentDecisionSource;
pub(super) use whisply_protocol::approvals::GuardianAssessmentEvent;
pub(super) use whisply_protocol::approvals::GuardianAssessmentStatus;
pub(super) use whisply_protocol::approvals::GuardianCommandSource;
pub(super) use whisply_protocol::approvals::GuardianRiskLevel;
pub(super) use whisply_protocol::approvals::GuardianUserAuthorization;
pub(super) use whisply_protocol::config_types::CollaborationMode;
pub(super) use whisply_protocol::config_types::ModeKind;
pub(super) use whisply_protocol::config_types::Personality;
pub(super) use whisply_protocol::config_types::SERVICE_TIER_DEFAULT_REQUEST_VALUE;
pub(super) use whisply_protocol::config_types::ServiceTier;
pub(super) use whisply_protocol::models::ActivePermissionProfile;
pub(super) use whisply_protocol::models::BUILT_IN_PERMISSION_PROFILE_WORKSPACE;
pub(super) use whisply_protocol::models::FileSystemPermissions;
pub(super) use whisply_protocol::models::MessagePhase;
pub(super) use whisply_protocol::models::NetworkPermissions;
pub(super) use whisply_protocol::models::PermissionProfile;
pub(super) use whisply_protocol::openai_models::ModelInfo;
pub(super) use whisply_protocol::openai_models::ModelPreset;
pub(super) use whisply_protocol::openai_models::ModelsResponse;
pub(super) use whisply_protocol::openai_models::ReasoningEffortPreset;
pub(super) use whisply_protocol::openai_models::default_input_modalities;
pub(super) use whisply_protocol::parse_command::ParsedCommand;
pub(super) use whisply_protocol::plan_tool::PlanItemArg;
pub(super) use whisply_protocol::plan_tool::StepStatus;
pub(super) use whisply_protocol::plan_tool::UpdatePlanArgs;
pub(super) use whisply_protocol::request_permissions::RequestPermissionProfile;
pub(super) use whisply_protocol::user_input::TextElement;
pub(super) use whisply_terminal_detection::Multiplexer;
pub(super) use whisply_terminal_detection::TerminalInfo;
pub(super) use whisply_terminal_detection::TerminalName;
pub(super) use whisply_utils_absolute_path::AbsolutePathBuf;
pub(super) use whisply_utils_approval_presets::builtin_approval_presets;
pub(super) use whisply_utils_path_uri::LegacyAppPathString;

pub(super) fn chatwidget_snapshot_dir() -> PathBuf {
    let snapshot_file = whisply_utils_cargo_bin::find_resource!(
        "src/chatwidget/snapshots/whisply_tui__chatwidget__tests__chatwidget_tall.snap"
    )
...
macro_rules! assert_chatwidget_snapshot {
    ($name:expr, $value:expr $(,)?) => {{
        ...
        settings.bind(|| {
            insta::assert_snapshot!(format!("whisply_tui__chatwidget__tests__{}", $name), $value);
        });
    }};
    ($name:expr, $value:expr, @$snapshot:literal $(,)?) => {{
        ...
        settings.bind(|| {
            insta::assert_snapshot!(
                format!("whisply_tui__chatwidget__tests__{}", $name),
                &($value),
                @$snapshot
            );
        });
