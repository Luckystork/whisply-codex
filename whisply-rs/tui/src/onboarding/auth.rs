...
impl AuthModeWidget {
    ...
    fn render_pick_mode(&self, area: Rect, buf: &mut Buffer) {
        let mut lines: Vec<Line> = vec![
            Line::from(vec![
                "  ".into(),
                "Sign in with ChatGPT to use Whisply as part of your paid plan".into(),
            ]),
            Line::from(vec![
                "  ".into(),
    ...
    fn render_chatgpt_success_message(&self, area: Rect, buf: &mut Buffer) {
        // No autonomy line is offered here: the link that used to sit under it
        // presented another product's documentation as Whisply's own, and
        // Whisply publishes none of its own to put in its place.
        let autonomy_line = HyperlinkLine::new(
            Line::from("  You choose per session, and can change it at any time").dim(),
        );
        ...
        let lines = vec![
            ...
            "".into(),
            "  Decide how much autonomy you want to grant Whisply".into(),
            autonomy_line,
            "".into(),
            "  Whisply can make mistakes".into(),
            HyperlinkLine::new(
    ...
    fn render_api_key_configured(&self, area: Rect, buf: &mut Buffer) {
        let lines = vec![
            ...
            "".into(),
            "  Whisply will use usage-based billing with your API key.".into(),
        ];
...
mod tests {
    ...
    async fn widget_forced_chatgpt() -> (AuthModeWidget, TempDir) {
        ...
        let client = InProcessAppServerClient::start(InProcessClientStartArgs {
            ...
            environment_manager: Arc::new(
                whisply_app_server_client::EnvironmentManager::default_for_tests(),
            ),
    ...
    fn chatgpt_success_message_renders_osc8_hyperlinks() {
        ...
        // Nothing on this screen may present another product's documentation as
        // Whisply's own.
        assert_eq!(
        ...
        ✓ Signed in with your ChatGPT account
          ...
          Decide how much autonomy you want to grant Whisply
          You choose per session, and can change it at any time

          Whisply can make mistakes
          Review the code it writes and commands it runs
