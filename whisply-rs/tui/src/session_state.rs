...
pub(crate) struct ThreadSessionState {
    ...
    pub(crate) approvals_reviewer: whisply_protocol::config_types::ApprovalsReviewer,
    ...
    pub(crate) reasoning_effort: Option<whisply_protocol::openai_models::ReasoningEffort>,
