...
fn plugin_remote_section_error_next_step(label: &str, err: &str) -> &'static str {
    ...
    {
        "Ask a workspace admin to enable Whisply plugins or plugin sharing."
        ...
        "Update Whisply, then try opening the shared plugin again."
...
fn plugin_sharing_disabled_remote_section_error() -> PluginRemoteSectionError {
    PluginRemoteSectionError {
        ...
        message: "Plugin sharing is disabled for this Whisply session. Enable plugin sharing to load shared plugins.".to_string(),
    }
}
...
pub(super) type McpInventoryMaps = (
    HashMap<String, whisply_protocol::mcp::Tool>,
    HashMap<String, Vec<whisply_protocol::mcp::Resource>>,
    HashMap<String, Vec<whisply_protocol::mcp::ResourceTemplate>>,
