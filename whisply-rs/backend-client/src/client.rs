...
use whisply_http_client::RouteAwareRequestBuilder;
...
use whisply_protocol::protocol::RateLimitReachedType;
use whisply_protocol::protocol::RateLimitSnapshot;
use whisply_protocol::protocol::RateLimitWindow;
use whisply_protocol::protocol::SpendControlLimitSnapshot;
...
impl Client {
    pub fn new(base_url: impl Into<String>, http_client_factory: HttpClientFactory) -> Self {
        ...
        Self {
            base_url,
            http,
            auth_provider: whisply_model_provider::unauthenticated_auth_provider(),
            user_agent: None,
    ...
    pub fn from_auth(
        ...
        Self::new(base_url, http_client_factory)
            ...
            .with_auth_provider(whisply_model_provider::auth_provider_from_auth(auth))
    }
    ...
    fn make_rate_limit_snapshot(
        ...
        spend_control: Option<whisply_backend_openapi_models::models::SpendControlStatusDetails>,
...
mod tests {
    ...
    use whisply_backend_openapi_models::models::AdditionalRateLimitDetails;
    use whisply_backend_openapi_models::models::RateLimitReachedKind;
    use whisply_backend_openapi_models::models::RateLimitReachedType as BackendRateLimitReachedType;
    use wiremock::Mock;
    ...
    fn usage_payload_maps_primary_and_additional_rate_limits() {
        let payload = RateLimitStatusPayload {
            ...
            spend_control: Some(Some(Box::new(
                whisply_backend_openapi_models::models::SpendControlStatusDetails {
                    reached: false,
    ...
    async fn user_settings_request_uses_expected_paths_and_revalidates_cached_responses() {
        ...
        let codex_response = Client::new(
            server.uri(),
            HttpClientFactory::new(whisply_http_client::OutboundProxyPolicy::ReqwestDefault),
        )
        .get_user_settings()
        .await
        .unwrap();
