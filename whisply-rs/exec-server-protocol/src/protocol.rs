...
pub use whisply_file_system::WalkOptions;
pub use whisply_file_system::WalkOutcome;
...
use whisply_shell_command::shell_detect::DetectedShell;
...
impl EnvironmentInfo {
    ...
    pub fn local() -> Self {
        Self {
            shell: whisply_shell_command::shell_detect::default_user_shell().into(),
...
mod tests {
    ...
    use whisply_network_proxy::RemoteNetworkProxyLaunchConfig;
    use whisply_protocol::config_types::WindowsSandboxProxySettingsMode;
