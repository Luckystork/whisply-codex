...
/// 2. The vendored bubblewrap tree under `whisply-rs/vendor/bubblewrap`.
...
Set CODEX_BWRAP_SOURCE_DIR to an existing checkout or vendor bubblewrap under whisply-rs/vendor.",
        vendor_dir.display()
    ))
}
