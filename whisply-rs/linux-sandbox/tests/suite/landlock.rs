...
async fn run_cmd_output(
    ...
    timeout_ms: u64,
) -> whisply_protocol::exec_output::ExecToolCallOutput {
...
async fn run_cmd_result_with_writable_roots(
    ...
    network_access: bool,
) -> Result<whisply_protocol::exec_output::ExecToolCallOutput> {
...
fn is_bwrap_unavailable_output(output: &whisply_protocol::exec_output::ExecToolCallOutput) -> bool {
...
fn expect_denied(
    result: Result<whisply_protocol::exec_output::ExecToolCallOutput>,
    context: &str,
) -> whisply_protocol::exec_output::ExecToolCallOutput {
    match result {
        Ok(output) => {
