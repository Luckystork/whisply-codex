...
use whisply_protocol::config_types::WebSearchFilters as ConfigWebSearchFilters;
use whisply_protocol::config_types::WebSearchUserLocation as ConfigWebSearchUserLocation;
