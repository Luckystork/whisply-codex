...
use anyhow::bail;
use clap::Parser;
use whisply_core_api::AbsolutePathBuf;
use whisply_core_api::AltScreenMode;
use whisply_core_api::ApprovalsReviewer;
use whisply_core_api::Arg0DispatchPaths;
use whisply_core_api::AskForApproval;
use whisply_core_api::AuthCredentialsStoreMode;
use whisply_core_api::AuthManager;
use whisply_core_api::AutoCompactTokenLimitScope;
use whisply_core_api::CodexAppsToolsCache;
use whisply_core_api::CodexHomeUserInstructionsProvider;
use whisply_core_api::CodexThread;
use whisply_core_api::Config;
use whisply_core_api::ConfigLayerStack;
use whisply_core_api::Constrained;
use whisply_core_api::EnvironmentManager;
use whisply_core_api::EventMsg;
use whisply_core_api::ExecServerRuntimePaths;
use whisply_core_api::ExtensionRegistryBuilder;
use whisply_core_api::Features;
use whisply_core_api::GhostSnapshotConfig;
use whisply_core_api::History;
use whisply_core_api::MemoriesConfig;
use whisply_core_api::ModelAvailabilityNuxConfig;
use whisply_core_api::MultiAgentV2Config;
use whisply_core_api::NewThread;
use whisply_core_api::Notice;
use whisply_core_api::OAuthCredentialsStoreMode;
use whisply_core_api::OPENAI_PROVIDER_ID;
use whisply_core_api::Op;
use whisply_core_api::OtelConfig;
use whisply_core_api::PermissionProfile;
use whisply_core_api::Permissions;
use whisply_core_api::ProjectConfig;
use whisply_core_api::RealtimeAudioConfig;
use whisply_core_api::RealtimeConfig;
use whisply_core_api::SessionPickerViewMode;
use whisply_core_api::SessionSource;
use whisply_core_api::SqliteConfig;
use whisply_core_api::StartThreadOptions;
use whisply_core_api::TerminalResizeReflowConfig;
use whisply_core_api::ThreadManager;
use whisply_core_api::ThreadStoreConfig;
use whisply_core_api::ToolSuggestConfig;
use whisply_core_api::TuiKeymap;
use whisply_core_api::TuiNotificationSettings;
use whisply_core_api::TuiPetAnchor;
use whisply_core_api::UriBasedFileOpener;
use whisply_core_api::UserInput;
use whisply_core_api::WebSearchMode;
use whisply_core_api::arg0_dispatch_or_else;
use whisply_core_api::build_models_manager;
use whisply_core_api::built_in_model_providers;
use whisply_core_api::find_codex_home;
use whisply_core_api::init_state_db;
use whisply_core_api::install_image_generation_extension;
use whisply_core_api::item_event_to_server_notification;
use whisply_core_api::local_agent_graph_store_from_state_db;
use whisply_core_api::resolve_installation_id;
use whisply_core_api::set_default_originator;
use whisply_core_api::thread_store_from_config;
...
fn new_config(model: Option<String>, arg0_paths: Arg0DispatchPaths) -> anyhow::Result<Config> {
    ...
    let mut config = Config {
        ...
        cwd: cwd.clone(),
        // This sample starts in whatever directory it was invoked from, which
        // is not a choice the user expressed.
