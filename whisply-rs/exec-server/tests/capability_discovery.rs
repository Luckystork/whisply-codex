...
use whisply_exec_server::CAPABILITY_ROOTS_DISCOVER_METHOD;
use whisply_exec_server::CapabilityRootDiscovery;
use whisply_exec_server::CapabilityRootsDiscoverParams;
use whisply_exec_server::CapabilityRootsDiscoverResponse;
