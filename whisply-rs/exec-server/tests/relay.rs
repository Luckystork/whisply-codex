...
fn static_registry_auth_provider() -> whisply_api::SharedAuthProvider {
...
async fn remote_environment_routes_encrypted_exec_server_rpc() -> Result<()> {
    ...
    let client_args = NoiseRendezvousConnectArgs {
        ...
        http_client_factory: whisply_http_client::HttpClientFactory::new(
