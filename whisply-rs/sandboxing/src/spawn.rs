...
pub async fn spawn_process(request: SpawnRequest<'_>) -> Result<SpawnedProcess> {
    if request.sandbox == SandboxType::WindowsRestrictedToken {
        #[cfg(target_os = "windows")]
        {
            ...
            return whisply_windows_sandbox::spawn_windows_sandbox_session_for_level(
                whisply_windows_sandbox::WindowsSandboxSessionRequest {
    ...
    if request.tty {
        whisply_utils_pty::pty::spawn_process(
            program,
            args,
            request.cwd,
            request.env,
        ...
        whisply_utils_pty::pipe::spawn_process(
            program,
            args,
            request.cwd,
            request.env,
        ...
        whisply_utils_pty::pipe::spawn_process_no_stdin(
            program,
            args,
            request.cwd,
            request.env,
