...
use whisply_protocol::openai_models::TruncationMode;
...
const DEFAULT_PERSONALITY_HEADER: &str = "You are Whisply, a coding agent based on GPT-5. You and the user share the same workspace and collaborate to achieve the user's goals.";
