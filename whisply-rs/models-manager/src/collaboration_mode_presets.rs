...
use whisply_collaboration_mode_templates::DEFAULT as COLLABORATION_MODE_DEFAULT;
use whisply_collaboration_mode_templates::PLAN as COLLABORATION_MODE_PLAN;
use whisply_protocol::config_types::CollaborationModeMask;
use whisply_protocol::config_types::ModeKind;
use whisply_protocol::config_types::TUI_VISIBLE_COLLABORATION_MODES;
